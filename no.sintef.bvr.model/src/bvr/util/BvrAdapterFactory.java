...
public class BvrAdapterFactory extends AdapterFactoryImpl {
	...
	protected BvrSwitch<Adapter> modelSwitch =
		new BvrSwitch<Adapter>() {
			...
			@Override
			public Adapter caseChoiceVSpec(ChoiceVSpec object) {
				return createChoiceVSpecAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link bvr.ChoiceVSpec <em>Choice VSpec</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createChoiceVSpecAdapter() {
		return null;
	}
