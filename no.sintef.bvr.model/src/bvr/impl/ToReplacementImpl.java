 ...
 * <ul>
 *   <li>{@link bvr.impl.ToReplacementImpl#getInsideBoundaryElement <em>Inside Boundary Element</em>}</li>
 *   <li>{@link bvr.impl.ToReplacementImpl#getOutsideBoundaryElement <em>Outside Boundary Element</em>}</li>
 *   <li>{@link bvr.impl.ToReplacementImpl#getToPlacement <em>To Placement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToReplacementImpl extends ReplacementBoundaryElementImpl implements ToReplacement {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.TO_REPLACEMENT;
	}
	...
	public EList<ObjectHandle> getInsideBoundaryElement() {
		if (insideBoundaryElement == null) {
			insideBoundaryElement = new EObjectResolvingEList<ObjectHandle>(ObjectHandle.class, this, BvrPackage.TO_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT);
		}
		...
		if (outsideBoundaryElement != null && outsideBoundaryElement.eIsProxy()) {
			...
			if (outsideBoundaryElement != oldOutsideBoundaryElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.TO_REPLACEMENT__OUTSIDE_BOUNDARY_ELEMENT, oldOutsideBoundaryElement, outsideBoundaryElement));
			}
		}
	...
	public void setOutsideBoundaryElement(ObjectHandle newOutsideBoundaryElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.TO_REPLACEMENT__OUTSIDE_BOUNDARY_ELEMENT, oldOutsideBoundaryElement, outsideBoundaryElement));
	}
	...
	public ToPlacement getToPlacement() {
		if (toPlacement != null && toPlacement.eIsProxy()) {
			...
			if (toPlacement != oldToPlacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.TO_REPLACEMENT__TO_PLACEMENT, oldToPlacement, toPlacement));
			}
		}
		return toPlacement;
	}
	...
	public NotificationChain basicSetToPlacement(ToPlacement newToPlacement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.TO_REPLACEMENT__TO_PLACEMENT, oldToPlacement, newToPlacement);
	...
	public void setToPlacement(ToPlacement newToPlacement) {
		if (newToPlacement != toPlacement) {
			...
			if (toPlacement != null)
				msgs = ((InternalEObject)toPlacement).eInverseRemove(this, BvrPackage.TO_PLACEMENT__TO_REPLACEMENT, ToPlacement.class, msgs);
			if (newToPlacement != null)
				msgs = ((InternalEObject)newToPlacement).eInverseAdd(this, BvrPackage.TO_PLACEMENT__TO_REPLACEMENT, ToPlacement.class, msgs);
			msgs = basicSetToPlacement(newToPlacement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.TO_REPLACEMENT__TO_PLACEMENT, newToPlacement, newToPlacement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.TO_REPLACEMENT__TO_PLACEMENT:
				if (toPlacement != null)
					msgs = ((InternalEObject)toPlacement).eInverseRemove(this, BvrPackage.TO_PLACEMENT__TO_REPLACEMENT, ToPlacement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.TO_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT:
				return getInsideBoundaryElement();
			case BvrPackage.TO_REPLACEMENT__OUTSIDE_BOUNDARY_ELEMENT:
