 ...
 * <ul>
 *   <li>{@link bvr.impl.SlotAssignmentImpl#getSlotIdentifier <em>Slot Identifier</em>}</li>
 *   <li>{@link bvr.impl.SlotAssignmentImpl#getValue <em>Value</em>}</li>
 *   <li>{@link bvr.impl.SlotAssignmentImpl#getSlotOwner <em>Slot Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlotAssignmentImpl extends ChoiceVariationPointImpl implements SlotAssignment {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.SLOT_ASSIGNMENT;
	}
	...
	public void setSlotIdentifier(String newSlotIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_ASSIGNMENT__SLOT_IDENTIFIER, oldSlotIdentifier, slotIdentifier));
	}
	...
	public NotificationChain basicSetValue(ValueSpecification newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_ASSIGNMENT__VALUE, oldValue, newValue);
	...
	public void setValue(ValueSpecification newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.SLOT_ASSIGNMENT__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.SLOT_ASSIGNMENT__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_ASSIGNMENT__VALUE, newValue, newValue));
	}
	...
	public NotificationChain basicSetSlotOwner(ObjectHandle newSlotOwner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_ASSIGNMENT__SLOT_OWNER, oldSlotOwner, newSlotOwner);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSlotOwner(ObjectHandle newSlotOwner) {
		if (newSlotOwner != slotOwner) {
			NotificationChain msgs = null;
			if (slotOwner != null)
				msgs = ((InternalEObject)slotOwner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.SLOT_ASSIGNMENT__SLOT_OWNER, null, msgs);
			if (newSlotOwner != null)
				msgs = ((InternalEObject)newSlotOwner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.SLOT_ASSIGNMENT__SLOT_OWNER, null, msgs);
			msgs = basicSetSlotOwner(newSlotOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_ASSIGNMENT__SLOT_OWNER, newSlotOwner, newSlotOwner));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.SLOT_ASSIGNMENT__VALUE:
				return basicSetValue(null, msgs);
			case BvrPackage.SLOT_ASSIGNMENT__SLOT_OWNER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.SLOT_ASSIGNMENT__SLOT_IDENTIFIER:
