 ...
 * <ul>
 *   <li>{@link bvr.impl.ObjectTypeImpl#getMetaClass <em>Meta Class</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectTypeImpl extends VariabletypeImpl implements ObjectType {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.OBJECT_TYPE;
	}
	...
	public void setMetaClass(String newMetaClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.OBJECT_TYPE__META_CLASS, oldMetaClass, metaClass));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.OBJECT_TYPE__META_CLASS:
				return getMetaClass();
		}
