/*******************************************************************************
 * Copyright (c) 2011, 2012 SINTEF, Martin F. Johansen. All rights reserved.
 * This program and the accompanying materials are made available under the
 * terms of the Eclipse Public License v1.0 which accompanies this distribution,
 * and is available at http://www.eclipse.org/legal/epl-v10.html
 *
 * Contributors: SINTEF, Martin F. Johansen - the implementation
 *******************************************************************************/
...
public class GUIDSL {
	...
	/*
	 * public GUIDSL(String model) throws UnsupportedModelException { fma = new
	 * de.ovgu.featureide.fm.core.FeatureModel(); GuidslReader fmr = new
	 * GuidslReader(fma); fmr.readFromString(model); }
	 */
	public GUIDSL(File file) throws UnsupportedModelException, IOException {
		...
		orgFileName = file.getAbsoluteFile().toString();
	}
	...
	public boolean equals(Object fmo) {
		 ...
		 * if(!fmb.getComments().containsAll(fm.getComments())) return false;
		 */
	...
	public GraphMLFM getGraphMLFM() throws ParserConfigurationException, SAXException {
		...
		for (Feature source : fma.getFeatures()) {
			...
			/*
			 * if(source.isOr()) System.out.println(source.getName() +
			 * " has OR"); if(source.isAlternative())
			 * System.out.println(source.getName() + " has ALTERNATIVE");
			 * if(source.isAnd()) System.out.println(source.getName() +
			 * " has AND");
			 */
			if (source.isOr()) {
