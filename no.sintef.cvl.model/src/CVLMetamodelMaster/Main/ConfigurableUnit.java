 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getOwnedVSpec <em>Owned VSpec</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getOwnedVariationPoint <em>Owned Variation Point</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getOwnedConstraint <em>Owned Constraint</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getConfigurableContainerObject <em>Configurable Container Object</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getOwnedVSpecResolution <em>Owned VSpec Resolution</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getUnitInterface <em>Unit Interface</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.ConfigurableUnit#getOwnedVSpecDerivation <em>Owned VSpec Derivation</em>}</li>
 * </ul>
 * </p>
 *
 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit()
 * @model
 * @generated
 */
public interface ConfigurableUnit extends CompositeVariationPoint {
	 ...
	 * The list contents are of type {@link CVLMetamodelMaster.Main.VSpec}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_OwnedVSpec()
	 ...
	 * The list contents are of type {@link CVLMetamodelMaster.Main.VariationPoint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_OwnedVariationPoint()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * The list contents are of type {@link CVLMetamodelMaster.Main.Constraint}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_OwnedConstraint()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_ConfigurableContainerObject()
	...
	/**
	 * Sets the value of the '{@link CVLMetamodelMaster.Main.ConfigurableUnit#getConfigurableContainerObject <em>Configurable Container Object</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_OwnedVSpecResolution()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_UnitInterface()
	...
	/**
	 * Sets the value of the '{@link CVLMetamodelMaster.Main.ConfigurableUnit#getUnitInterface <em>Unit Interface</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getConfigurableUnit_OwnedVSpecDerivation()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
