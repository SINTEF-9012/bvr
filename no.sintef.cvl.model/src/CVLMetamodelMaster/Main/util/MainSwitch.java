/**
 */
package CVLMetamodelMaster.Main.util;
 ...
 * <!-- end-user-doc -->
 * @see CVLMetamodelMaster.Main.MainPackage
 * @generated
 */
public class MainSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MainPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MainPackage.MULTIPLICITY_INTERVAL: {
			...
			case MainPackage.VSPEC_DERIVATION: {
			...
			case MainPackage.VSPEC_RESOLUTION: {
			...
			case MainPackage.CHOICE_RESOLUTUION: {
			...
			case MainPackage.VARIATION_POINT: {
			...
			case MainPackage.FRAGMENT_SUBSTITUTION: {
			...
			case MainPackage.CHOICE_VARIATION_POINT: {
			...
			case MainPackage.REPEATABLE_VARIATION_POINT: {
			...
			case MainPackage.BOUNDARY_ELEMENT_BINDING: {
			...
			case MainPackage.PLACEMENT_FRAGMENT: {
			...
			case MainPackage.PLACEMENT_BOUNDARY_ELEMENT: {
			...
			case MainPackage.REPLACEMENT_FRAGMENT_TYPE: {
			...
			case MainPackage.OBJECT_SUBSTITUTION: {
			...
			case MainPackage.OBJECT_HANDLE: {
			...
			case MainPackage.PRIMITVE_TYPE: {
			...
			case MainPackage.SLOT_ASSIGNMENT: {
			...
			case MainPackage.OBJECT_EXISTENCE: {
			...
			case MainPackage.LINK_END_SUBSTITUTION: {
			...
			case MainPackage.CONFIGURABLE_UNIT: {
			...
			case MainPackage.COMPOSITE_VARIATION_POINT: {
			...
			case MainPackage.VCONFIGURATION: {
			...
			case MainPackage.LINK_EXISTENCE: {
			...
			case MainPackage.OPAQUE_VARIATION_POINT: {
			...
			case MainPackage.REPLACEMENT_FRAGMENT_SPECIFICATION: {
			...
			case MainPackage.TO_REPLACEMENT: {
			...
			case MainPackage.FROM_PLACEMENT: {
			...
			case MainPackage.FROM_REPLACEMENT: {
			...
			case MainPackage.PARAMETRIC_VARIATION_POINT: {
			...
			case MainPackage.SLOT_VALUE_EXISTENCE: {
			...
			case MainPackage.PARAMETRIC_LINK_END_SUBSTITUTION: {
			...
			case MainPackage.PARAMETRIC_OBJECT_SUBSTITUTION: {
			...
			case MainPackage.PARAMETRIC_SLOT_ASSIGNMET: {
			...
			case MainPackage.CHOICE_DERIVATION: {
			...
			case MainPackage.VARIABLE_DERIVATION: {
			...
			case MainPackage.CV_SPEC_DERIVATION: {
			...
			case MainPackage.CONFIGURABLE_UNIT_USAGE: {
			...
			case MainPackage.PRIMITIVE_VALUE_SPECIFICATION: {
			...
			case MainPackage.BCL_CONSTRAINT: {
			...
			case MainPackage.OPERATION_CALL_EXP: {
			...
			case MainPackage.BOOLEAN_LITERAL_EXP: {
			...
			case MainPackage.STRING_LITERAL_EXP: {
			...
			case MainPackage.NUMERIC_LITERAL_EXP: {
			...
			case MainPackage.INTEGER_LITERAL_EXP: {
			...
			case MainPackage.UNLIMITED_LITERAL_EXP: {
			...
			case MainPackage.REAL_LITERAL_EXP: {
