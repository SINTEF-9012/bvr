 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.SlotAssignment#getSlotIdentifier <em>Slot Identifier</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.SlotAssignment#getValue <em>Value</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.SlotAssignment#getSlotOwner <em>Slot Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @see CVLMetamodelMaster.Main.MainPackage#getSlotAssignment()
 * @model
 * @generated
 */
public interface SlotAssignment extends ChoiceVariationPoint {
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getSlotAssignment_SlotIdentifier()
	...
	/**
	 * Sets the value of the '{@link CVLMetamodelMaster.Main.SlotAssignment#getSlotIdentifier <em>Slot Identifier</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getSlotAssignment_Value()
	...
	/**
	 * Sets the value of the '{@link CVLMetamodelMaster.Main.SlotAssignment#getValue <em>Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#getSlotAssignment_SlotOwner()
	...
	/**
	 * Sets the value of the '{@link CVLMetamodelMaster.Main.SlotAssignment#getSlotOwner <em>Slot Owner</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
