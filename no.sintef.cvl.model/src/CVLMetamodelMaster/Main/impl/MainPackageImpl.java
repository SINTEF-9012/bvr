...
import CVLMetamodelMaster.Main.BaseModelHandle;
import CVLMetamodelMaster.Main.BooleanLiteralExp;
import CVLMetamodelMaster.Main.BoundaryElementBinding;
...
import CVLMetamodelMaster.Main.ChoiceResolutuion;
import CVLMetamodelMaster.Main.ChoiceVariationPoint;
import CVLMetamodelMaster.Main.CompositeVariationPoint;
import CVLMetamodelMaster.Main.ConfigurableUnit;
import CVLMetamodelMaster.Main.ConfigurableUnitUsage;
import CVLMetamodelMaster.Main.Constraint;
import CVLMetamodelMaster.Main.FragmentSubstitution;
import CVLMetamodelMaster.Main.FromBinding;
import CVLMetamodelMaster.Main.FromPlacement;
import CVLMetamodelMaster.Main.FromReplacement;
import CVLMetamodelMaster.Main.IntegerLiteralExp;
import CVLMetamodelMaster.Main.LinkEndSubstitution;
import CVLMetamodelMaster.Main.LinkExistence;
...
import CVLMetamodelMaster.Main.NamedElement;
import CVLMetamodelMaster.Main.NumericLiteralExp;
import CVLMetamodelMaster.Main.OVPSemanticSpec;
import CVLMetamodelMaster.Main.OVPType;
import CVLMetamodelMaster.Main.ObjectExistence;
import CVLMetamodelMaster.Main.ObjectHandle;
import CVLMetamodelMaster.Main.ObjectSpecification;
import CVLMetamodelMaster.Main.ObjectSubstitution;
import CVLMetamodelMaster.Main.ObjectType;
import CVLMetamodelMaster.Main.OpaqueConstraint;
import CVLMetamodelMaster.Main.OpaqueVariationPoint;
import CVLMetamodelMaster.Main.Operation;
import CVLMetamodelMaster.Main.OperationCallExp;
import CVLMetamodelMaster.Main.ParametricLinkEndSubstitution;
import CVLMetamodelMaster.Main.ParametricObjectSubstitution;
import CVLMetamodelMaster.Main.ParametricSlotAssignmet;
import CVLMetamodelMaster.Main.ParametricVariationPoint;
import CVLMetamodelMaster.Main.PlacementBoundaryElement;
import CVLMetamodelMaster.Main.PlacementFragment;
import CVLMetamodelMaster.Main.PrimitiveTypeEnum;
import CVLMetamodelMaster.Main.PrimitiveValueSpecification;
import CVLMetamodelMaster.Main.PrimitveType;
import CVLMetamodelMaster.Main.RealLiteralExp;
import CVLMetamodelMaster.Main.RepeatableVariationPoint;
import CVLMetamodelMaster.Main.ReplacementBoundaryElement;
import CVLMetamodelMaster.Main.ReplacementFragmentSpecification;
import CVLMetamodelMaster.Main.ReplacementFragmentType;
import CVLMetamodelMaster.Main.SlotAssignment;
import CVLMetamodelMaster.Main.SlotValueExistence;
import CVLMetamodelMaster.Main.StringLiteralExp;
import CVLMetamodelMaster.Main.ToBinding;
import CVLMetamodelMaster.Main.ToPlacement;
import CVLMetamodelMaster.Main.ToReplacement;
import CVLMetamodelMaster.Main.UnlimitedLiteralExp;
import CVLMetamodelMaster.Main.VClassifier;
import CVLMetamodelMaster.Main.VConfiguration;
import CVLMetamodelMaster.Main.VInstance;
import CVLMetamodelMaster.Main.VInterface;
import CVLMetamodelMaster.Main.VPackage;
import CVLMetamodelMaster.Main.VPackageable;
import CVLMetamodelMaster.Main.VSpec;
import CVLMetamodelMaster.Main.VSpecDerivation;
import CVLMetamodelMaster.Main.VSpecRef;
import CVLMetamodelMaster.Main.VSpecResolution;
import CVLMetamodelMaster.Main.ValueSpecification;
import CVLMetamodelMaster.Main.Variable;
import CVLMetamodelMaster.Main.VariableDerivation;
import CVLMetamodelMaster.Main.VariableValueAssignment;
import CVLMetamodelMaster.Main.Variabletype;
...
public class MainPackageImpl extends EPackageImpl implements MainPackage {
	 ...
	 * @see CVLMetamodelMaster.Main.MainPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
