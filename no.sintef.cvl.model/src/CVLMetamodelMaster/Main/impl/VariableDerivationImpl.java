 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VariableDerivationImpl#getDerivingExpression <em>Deriving Expression</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VariableDerivationImpl#getDerivedVariable <em>Derived Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDerivationImpl extends VSpecDerivationImpl implements VariableDerivation {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VARIABLE_DERIVATION;
	}
	...
	public NotificationChain basicSetDerivingExpression(BCLExpression newDerivingExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE_DERIVATION__DERIVING_EXPRESSION, oldDerivingExpression, newDerivingExpression);
	...
	public void setDerivingExpression(BCLExpression newDerivingExpression) {
		if (newDerivingExpression != derivingExpression) {
			...
			if (derivingExpression != null)
				msgs = ((InternalEObject)derivingExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.VARIABLE_DERIVATION__DERIVING_EXPRESSION, null, msgs);
			if (newDerivingExpression != null)
				msgs = ((InternalEObject)newDerivingExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.VARIABLE_DERIVATION__DERIVING_EXPRESSION, null, msgs);
			msgs = basicSetDerivingExpression(newDerivingExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE_DERIVATION__DERIVING_EXPRESSION, newDerivingExpression, newDerivingExpression));
	}
	...
	public Variable getDerivedVariable() {
		if (derivedVariable != null && derivedVariable.eIsProxy()) {
			...
			if (derivedVariable != oldDerivedVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VARIABLE_DERIVATION__DERIVED_VARIABLE, oldDerivedVariable, derivedVariable));
			}
		}
	...
	public void setDerivedVariable(Variable newDerivedVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE_DERIVATION__DERIVED_VARIABLE, oldDerivedVariable, derivedVariable));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.VARIABLE_DERIVATION__DERIVING_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MainPackage.VARIABLE_DERIVATION__DERIVED_VARIABLE:
