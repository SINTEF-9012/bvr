 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.UnlimitedLiteralExpImpl#getUnlimited <em>Unlimited</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnlimitedLiteralExpImpl extends NumericLiteralExpImpl implements UnlimitedLiteralExp {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.UNLIMITED_LITERAL_EXP;
	}
	...
	public void setUnlimited(int newUnlimited) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.UNLIMITED_LITERAL_EXP__UNLIMITED, oldUnlimited, unlimited));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.UNLIMITED_LITERAL_EXP__UNLIMITED:
				return getUnlimited();
		}
