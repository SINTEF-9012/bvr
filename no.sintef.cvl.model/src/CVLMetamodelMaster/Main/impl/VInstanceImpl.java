 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VInstanceImpl extends VSpecResolutionImpl implements VInstance {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VINSTANCE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VINSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(VClassifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VINSTANCE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.VINSTANCE__TYPE:
