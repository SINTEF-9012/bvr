 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.OVPSemanticSpecImpl#getModelTransformation <em>Model Transformation</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.OVPSemanticSpecImpl#getTransfromationLanguage <em>Transfromation Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OVPSemanticSpecImpl extends EObjectImpl implements OVPSemanticSpec {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.OVP_SEMANTIC_SPEC;
	}
	...
	public void setModelTransformation(String newModelTransformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.OVP_SEMANTIC_SPEC__MODEL_TRANSFORMATION, oldModelTransformation, modelTransformation));
	}
	...
	public void setTransfromationLanguage(String newTransfromationLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.OVP_SEMANTIC_SPEC__TRANSFROMATION_LANGUAGE, oldTransfromationLanguage, transfromationLanguage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.OVP_SEMANTIC_SPEC__MODEL_TRANSFORMATION:
				return getModelTransformation();
			case MainPackage.OVP_SEMANTIC_SPEC__TRANSFROMATION_LANGUAGE:
