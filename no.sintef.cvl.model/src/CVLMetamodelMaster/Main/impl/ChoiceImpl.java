 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ChoiceImpl#isDefaultResolution <em>Default Resolution</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ChoiceImpl#isIsImpliedByParent <em>Is Implied By Parent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceImpl extends VSpecImpl implements Choice {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.CHOICE;
	}
	...
	public void setDefaultResolution(boolean newDefaultResolution) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CHOICE__DEFAULT_RESOLUTION, oldDefaultResolution, defaultResolution));
	}
	...
	public void setIsImpliedByParent(boolean newIsImpliedByParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CHOICE__IS_IMPLIED_BY_PARENT, oldIsImpliedByParent, isImpliedByParent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.CHOICE__DEFAULT_RESOLUTION:
				return isDefaultResolution();
			case MainPackage.CHOICE__IS_IMPLIED_BY_PARENT:
