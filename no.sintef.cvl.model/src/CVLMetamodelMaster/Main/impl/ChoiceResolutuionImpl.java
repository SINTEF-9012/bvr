 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ChoiceResolutuionImpl#getResolvedChoice <em>Resolved Choice</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ChoiceResolutuionImpl#isDecision <em>Decision</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceResolutuionImpl extends VSpecResolutionImpl implements ChoiceResolutuion {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.CHOICE_RESOLUTUION;
	}
		...
		if (resolvedChoice != null && resolvedChoice.eIsProxy()) {
			...
			if (resolvedChoice != oldResolvedChoice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.CHOICE_RESOLUTUION__RESOLVED_CHOICE, oldResolvedChoice, resolvedChoice));
			}
		}
	...
	public void setResolvedChoice(Choice newResolvedChoice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CHOICE_RESOLUTUION__RESOLVED_CHOICE, oldResolvedChoice, resolvedChoice));
	}
	...
	public void setDecision(boolean newDecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CHOICE_RESOLUTUION__DECISION, oldDecision, decision));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.CHOICE_RESOLUTUION__RESOLVED_CHOICE:
				if (resolve) return getResolvedChoice();
				return basicGetResolvedChoice();
			case MainPackage.CHOICE_RESOLUTUION__DECISION:
				return isDecision();
		}
