 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.IntegerLiteralExpImpl#getInteger <em>Integer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralExpImpl extends NumericLiteralExpImpl implements IntegerLiteralExp {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.INTEGER_LITERAL_EXP;
	}
	...
	public void setInteger(int newInteger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.INTEGER_LITERAL_EXP__INTEGER, oldInteger, integer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.INTEGER_LITERAL_EXP__INTEGER:
				return getInteger();
		}
