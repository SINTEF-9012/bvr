 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ConfigurableUnitUsageImpl#getUsedUnit <em>Used Unit</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ConfigurableUnitUsageImpl#getUsageReference <em>Usage Reference</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ConfigurableUnitUsageImpl#getLinkEndIdentifier <em>Link End Identifier</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ConfigurableUnitUsageImpl#getUnitUsageInterface <em>Unit Usage Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConfigurableUnitUsageImpl extends CompositeVariationPointImpl implements ConfigurableUnitUsage {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.CONFIGURABLE_UNIT_USAGE;
	}
		...
		if (usedUnit != null && usedUnit.eIsProxy()) {
			...
			if (usedUnit != oldUsedUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.CONFIGURABLE_UNIT_USAGE__USED_UNIT, oldUsedUnit, usedUnit));
			}
		}
		return usedUnit;
	}
	...
	public void setUsedUnit(ConfigurableUnit newUsedUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CONFIGURABLE_UNIT_USAGE__USED_UNIT, oldUsedUnit, usedUnit));
	}
	...
	public NotificationChain basicSetUsageReference(LinkHandle newUsageReference, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.CONFIGURABLE_UNIT_USAGE__USAGE_REFERENCE, oldUsageReference, newUsageReference);
	...
	public void setUsageReference(LinkHandle newUsageReference) {
		if (newUsageReference != usageReference) {
			...
			if (usageReference != null)
				msgs = ((InternalEObject)usageReference).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.CONFIGURABLE_UNIT_USAGE__USAGE_REFERENCE, null, msgs);
			if (newUsageReference != null)
				msgs = ((InternalEObject)newUsageReference).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.CONFIGURABLE_UNIT_USAGE__USAGE_REFERENCE, null, msgs);
			msgs = basicSetUsageReference(newUsageReference, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CONFIGURABLE_UNIT_USAGE__USAGE_REFERENCE, newUsageReference, newUsageReference));
	}
	...
	public void setLinkEndIdentifier(String newLinkEndIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CONFIGURABLE_UNIT_USAGE__LINK_END_IDENTIFIER, oldLinkEndIdentifier, linkEndIdentifier));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.CONFIGURABLE_UNIT_USAGE__USAGE_REFERENCE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.CONFIGURABLE_UNIT_USAGE__USED_UNIT:
				if (resolve) return getUsedUnit();
				return basicGetUsedUnit();
			case MainPackage.CONFIGURABLE_UNIT_USAGE__USAGE_REFERENCE:
				return getUsageReference();
			case MainPackage.CONFIGURABLE_UNIT_USAGE__LINK_END_IDENTIFIER:
				return getLinkEndIdentifier();
			case MainPackage.CONFIGURABLE_UNIT_USAGE__UNIT_USAGE_INTERFACE:
