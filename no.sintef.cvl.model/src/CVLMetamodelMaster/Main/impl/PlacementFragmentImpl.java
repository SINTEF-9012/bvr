 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.PlacementFragmentImpl#getPlacementBoundaryElement <em>Placement Boundary Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlacementFragmentImpl extends VariationPointImpl implements PlacementFragment {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.PLACEMENT_FRAGMENT;
	}
	...
	public EList<PlacementBoundaryElement> getPlacementBoundaryElement() {
		if (placementBoundaryElement == null) {
			placementBoundaryElement = new EObjectContainmentEList<PlacementBoundaryElement>(PlacementBoundaryElement.class, this, MainPackage.PLACEMENT_FRAGMENT__PLACEMENT_BOUNDARY_ELEMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.PLACEMENT_FRAGMENT__PLACEMENT_BOUNDARY_ELEMENT:
