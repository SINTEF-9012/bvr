 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ObjectSubstitutionImpl#getPlacementObject <em>Placement Object</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ObjectSubstitutionImpl#getReplacementObject <em>Replacement Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectSubstitutionImpl extends ChoiceVariationPointImpl implements ObjectSubstitution {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.OBJECT_SUBSTITUTION;
	}
	...
	public NotificationChain basicSetPlacementObject(ObjectHandle newPlacementObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, oldPlacementObject, newPlacementObject);
	...
	public void setPlacementObject(ObjectHandle newPlacementObject) {
		if (newPlacementObject != placementObject) {
			...
			if (placementObject != null)
				msgs = ((InternalEObject)placementObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, null, msgs);
			if (newPlacementObject != null)
				msgs = ((InternalEObject)newPlacementObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, null, msgs);
			msgs = basicSetPlacementObject(newPlacementObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, newPlacementObject, newPlacementObject));
	}
	...
	public NotificationChain basicSetReplacementObject(ObjectHandle newReplacementObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_SUBSTITUTION__REPLACEMENT_OBJECT, oldReplacementObject, newReplacementObject);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReplacementObject(ObjectHandle newReplacementObject) {
		if (newReplacementObject != replacementObject) {
			...
			if (replacementObject != null)
				msgs = ((InternalEObject)replacementObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.OBJECT_SUBSTITUTION__REPLACEMENT_OBJECT, null, msgs);
			if (newReplacementObject != null)
				msgs = ((InternalEObject)newReplacementObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.OBJECT_SUBSTITUTION__REPLACEMENT_OBJECT, null, msgs);
			msgs = basicSetReplacementObject(newReplacementObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_SUBSTITUTION__REPLACEMENT_OBJECT, newReplacementObject, newReplacementObject));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.OBJECT_SUBSTITUTION__PLACEMENT_OBJECT:
				return basicSetPlacementObject(null, msgs);
			case MainPackage.OBJECT_SUBSTITUTION__REPLACEMENT_OBJECT:
