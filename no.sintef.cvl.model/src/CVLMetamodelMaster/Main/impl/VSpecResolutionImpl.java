 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VSpecResolutionImpl#getResolvedVSpec <em>Resolved VSpec</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VSpecResolutionImpl#getChild <em>Child</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class VSpecResolutionImpl extends VPackageableImpl implements VSpecResolution {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VSPEC_RESOLUTION;
	}
		...
		if (resolvedVSpec != null && resolvedVSpec.eIsProxy()) {
			...
			if (resolvedVSpec != oldResolvedVSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VSPEC_RESOLUTION__RESOLVED_VSPEC, oldResolvedVSpec, resolvedVSpec));
			}
		}
	...
	public void setResolvedVSpec(VSpec newResolvedVSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VSPEC_RESOLUTION__RESOLVED_VSPEC, oldResolvedVSpec, resolvedVSpec));
	}
	...
	public EList<VSpecResolution> getChild() {
		if (child == null) {
			child = new EObjectContainmentEList<VSpecResolution>(VSpecResolution.class, this, MainPackage.VSPEC_RESOLUTION__CHILD);
		}
		return child;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.VSPEC_RESOLUTION__CHILD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.VSPEC_RESOLUTION__RESOLVED_VSPEC:
