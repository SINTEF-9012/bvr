 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FromBindingImpl#getFromPlacement <em>From Placement</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FromBindingImpl#getFromReplacement <em>From Replacement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromBindingImpl extends BoundaryElementBindingImpl implements FromBinding {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.FROM_BINDING;
	}
		...
		if (fromPlacement != null && fromPlacement.eIsProxy()) {
			...
			if (fromPlacement != oldFromPlacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.FROM_BINDING__FROM_PLACEMENT, oldFromPlacement, fromPlacement));
			}
		}
	...
	public void setFromPlacement(FromPlacement newFromPlacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FROM_BINDING__FROM_PLACEMENT, oldFromPlacement, fromPlacement));
	}
	...
	public FromReplacement getFromReplacement() {
		if (fromReplacement != null && fromReplacement.eIsProxy()) {
			...
			if (fromReplacement != oldFromReplacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.FROM_BINDING__FROM_REPLACEMENT, oldFromReplacement, fromReplacement));
			}
		}
	...
	public void setFromReplacement(FromReplacement newFromReplacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FROM_BINDING__FROM_REPLACEMENT, oldFromReplacement, fromReplacement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.FROM_BINDING__FROM_PLACEMENT:
				if (resolve) return getFromPlacement();
				return basicGetFromPlacement();
			case MainPackage.FROM_BINDING__FROM_REPLACEMENT:
