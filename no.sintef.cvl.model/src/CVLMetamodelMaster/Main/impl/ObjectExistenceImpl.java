 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ObjectExistenceImpl#getOptionalObject <em>Optional Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectExistenceImpl extends ChoiceVariationPointImpl implements ObjectExistence {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.OBJECT_EXISTENCE;
	}
	...
	public NotificationChain basicSetOptionalObject(ObjectHandle newOptionalObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_EXISTENCE__OPTIONAL_OBJECT, oldOptionalObject, newOptionalObject);
	...
	public void setOptionalObject(ObjectHandle newOptionalObject) {
		if (newOptionalObject != optionalObject) {
			...
			if (optionalObject != null)
				msgs = ((InternalEObject)optionalObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.OBJECT_EXISTENCE__OPTIONAL_OBJECT, null, msgs);
			if (newOptionalObject != null)
				msgs = ((InternalEObject)newOptionalObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.OBJECT_EXISTENCE__OPTIONAL_OBJECT, null, msgs);
			msgs = basicSetOptionalObject(newOptionalObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_EXISTENCE__OPTIONAL_OBJECT, newOptionalObject, newOptionalObject));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.OBJECT_EXISTENCE__OPTIONAL_OBJECT:
