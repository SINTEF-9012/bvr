 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ObjectHandleImpl#getMOFRef <em>MOF Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectHandleImpl extends BaseModelHandleImpl implements ObjectHandle {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.OBJECT_HANDLE;
	}
	...
	public void setMOFRef(String newMOFRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.OBJECT_HANDLE__MOF_REF, oldMOFRef, mofRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.OBJECT_HANDLE__MOF_REF:
				return getMOFRef();
		}
