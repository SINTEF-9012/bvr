 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VConfigurationImpl#getMember <em>Member</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VConfigurationImpl#isIsPartial <em>Is Partial</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VConfigurationImpl#getResolvedCVSpec <em>Resolved CV Spec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VConfigurationImpl extends VSpecResolutionImpl implements VConfiguration {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VCONFIGURATION;
	}
	...
	public EList<VSpecResolution> getMember() {
		if (member == null) {
			member = new EObjectContainmentEList<VSpecResolution>(VSpecResolution.class, this, MainPackage.VCONFIGURATION__MEMBER);
		}
		return member;
	}
	...
	public void setIsPartial(boolean newIsPartial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VCONFIGURATION__IS_PARTIAL, oldIsPartial, isPartial));
	}
	...
	public CVSpec getResolvedCVSpec() {
		if (resolvedCVSpec != null && resolvedCVSpec.eIsProxy()) {
			...
			if (resolvedCVSpec != oldResolvedCVSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VCONFIGURATION__RESOLVED_CV_SPEC, oldResolvedCVSpec, resolvedCVSpec));
			}
		}
	...
	public void setResolvedCVSpec(CVSpec newResolvedCVSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VCONFIGURATION__RESOLVED_CV_SPEC, oldResolvedCVSpec, resolvedCVSpec));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.VCONFIGURATION__MEMBER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.VCONFIGURATION__MEMBER:
				return getMember();
			case MainPackage.VCONFIGURATION__IS_PARTIAL:
				return isIsPartial();
			case MainPackage.VCONFIGURATION__RESOLVED_CV_SPEC:
