 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VariableImpl#getReplacementFragmentTypesubsetstype <em>Replacement Fragment Typesubsetstype</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VariableImpl#getDefaulValue <em>Defaul Value</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VariableImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends VSpecImpl implements Variable {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VARIABLE;
	}
		...
		if (replacementFragmentTypesubsetstype != null && replacementFragmentTypesubsetstype.eIsProxy()) {
			...
			if (replacementFragmentTypesubsetstype != oldReplacementFragmentTypesubsetstype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VARIABLE__REPLACEMENT_FRAGMENT_TYPESUBSETSTYPE, oldReplacementFragmentTypesubsetstype, replacementFragmentTypesubsetstype));
			}
		}
	...
	public void setReplacementFragmentTypesubsetstype(ReplacementFragmentType newReplacementFragmentTypesubsetstype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE__REPLACEMENT_FRAGMENT_TYPESUBSETSTYPE, oldReplacementFragmentTypesubsetstype, replacementFragmentTypesubsetstype));
	}
	...
	public NotificationChain basicSetDefaulValue(ValueSpecification newDefaulValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE__DEFAUL_VALUE, oldDefaulValue, newDefaulValue);
	...
	public void setDefaulValue(ValueSpecification newDefaulValue) {
		if (newDefaulValue != defaulValue) {
			...
			if (defaulValue != null)
				msgs = ((InternalEObject)defaulValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.VARIABLE__DEFAUL_VALUE, null, msgs);
			if (newDefaulValue != null)
				msgs = ((InternalEObject)newDefaulValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.VARIABLE__DEFAUL_VALUE, null, msgs);
			msgs = basicSetDefaulValue(newDefaulValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE__DEFAUL_VALUE, newDefaulValue, newDefaulValue));
	}
	...
	public Variabletype getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VARIABLE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Variabletype newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VARIABLE__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.VARIABLE__DEFAUL_VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.VARIABLE__REPLACEMENT_FRAGMENT_TYPESUBSETSTYPE:
			...
			case MainPackage.VARIABLE__TYPE:
