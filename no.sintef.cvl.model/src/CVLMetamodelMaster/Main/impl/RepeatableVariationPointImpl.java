 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.RepeatableVariationPointImpl#getBindingClassifier <em>Binding Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RepeatableVariationPointImpl extends VariationPointImpl implements RepeatableVariationPoint {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.REPEATABLE_VARIATION_POINT;
	}
		...
		if (bindingClassifier != null && bindingClassifier.eIsProxy()) {
			...
			if (bindingClassifier != oldBindingClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER, oldBindingClassifier, bindingClassifier));
			}
		}
	...
	public void setBindingClassifier(VClassifier newBindingClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER, oldBindingClassifier, bindingClassifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER:
