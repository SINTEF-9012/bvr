 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToBindingImpl#getToPlacement <em>To Placement</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToBindingImpl#getToReplacement <em>To Replacement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToBindingImpl extends BoundaryElementBindingImpl implements ToBinding {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.TO_BINDING;
	}
		...
		if (toPlacement != null && toPlacement.eIsProxy()) {
			...
			if (toPlacement != oldToPlacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.TO_BINDING__TO_PLACEMENT, oldToPlacement, toPlacement));
			}
		}
		return toPlacement;
	}
	...
	public void setToPlacement(ToPlacement newToPlacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.TO_BINDING__TO_PLACEMENT, oldToPlacement, toPlacement));
	}
	...
	public ToReplacement getToReplacement() {
		if (toReplacement != null && toReplacement.eIsProxy()) {
			...
			if (toReplacement != oldToReplacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.TO_BINDING__TO_REPLACEMENT, oldToReplacement, toReplacement));
			}
		}
	...
	public void setToReplacement(ToReplacement newToReplacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.TO_BINDING__TO_REPLACEMENT, oldToReplacement, toReplacement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.TO_BINDING__TO_PLACEMENT:
				if (resolve) return getToPlacement();
				return basicGetToPlacement();
			case MainPackage.TO_BINDING__TO_REPLACEMENT:
