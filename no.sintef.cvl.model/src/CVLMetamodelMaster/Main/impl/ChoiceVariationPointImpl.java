 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ChoiceVariationPointImpl#getBindingChoice <em>Binding Choice</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ChoiceVariationPointImpl extends VariationPointImpl implements ChoiceVariationPoint {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.CHOICE_VARIATION_POINT;
	}
		...
		if (bindingChoice != null && bindingChoice.eIsProxy()) {
			...
			if (bindingChoice != oldBindingChoice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.CHOICE_VARIATION_POINT__BINDING_CHOICE, oldBindingChoice, bindingChoice));
			}
		}
	...
	public void setBindingChoice(Choice newBindingChoice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CHOICE_VARIATION_POINT__BINDING_CHOICE, oldBindingChoice, bindingChoice));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.CHOICE_VARIATION_POINT__BINDING_CHOICE:
