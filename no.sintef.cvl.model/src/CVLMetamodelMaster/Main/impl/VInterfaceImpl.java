 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VInterfaceImpl#getMember <em>Member</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VInterfaceImpl#getOwnedConstraint <em>Owned Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VInterfaceImpl extends VPackageableImpl implements VInterface {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VINTERFACE;
	}
	...
	public EList<VSpec> getMember() {
		if (member == null) {
			member = new EObjectContainmentEList<VSpec>(VSpec.class, this, MainPackage.VINTERFACE__MEMBER);
		}
		return member;
	}
	...
	public EList<Constraint> getOwnedConstraint() {
		if (ownedConstraint == null) {
			ownedConstraint = new EObjectContainmentEList<Constraint>(Constraint.class, this, MainPackage.VINTERFACE__OWNED_CONSTRAINT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.VINTERFACE__MEMBER:
				return ((InternalEList<?>)getMember()).basicRemove(otherEnd, msgs);
			case MainPackage.VINTERFACE__OWNED_CONSTRAINT:
