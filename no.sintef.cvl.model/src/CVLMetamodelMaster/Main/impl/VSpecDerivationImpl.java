 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VSpecDerivationImpl#getDerivedVSpec <em>Derived VSpec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VSpecDerivationImpl extends VPackageableImpl implements VSpecDerivation {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VSPEC_DERIVATION;
	}
		...
		if (derivedVSpec != null && derivedVSpec.eIsProxy()) {
			...
			if (derivedVSpec != oldDerivedVSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.VSPEC_DERIVATION__DERIVED_VSPEC, oldDerivedVSpec, derivedVSpec));
			}
		}
		return derivedVSpec;
	}
	...
	public void setDerivedVSpec(VSpec newDerivedVSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VSPEC_DERIVATION__DERIVED_VSPEC, oldDerivedVSpec, derivedVSpec));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.VSPEC_DERIVATION__DERIVED_VSPEC:
