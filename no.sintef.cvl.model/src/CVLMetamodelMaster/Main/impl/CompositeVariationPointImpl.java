 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.CompositeVariationPointImpl#getBindingCVSpec <em>Binding CV Spec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CompositeVariationPointImpl extends VariationPointImpl implements CompositeVariationPoint {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.COMPOSITE_VARIATION_POINT;
	}
		...
		if (bindingCVSpec != null && bindingCVSpec.eIsProxy()) {
			...
			if (bindingCVSpec != oldBindingCVSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.COMPOSITE_VARIATION_POINT__BINDING_CV_SPEC, oldBindingCVSpec, bindingCVSpec));
			}
		}
	...
	public void setBindingCVSpec(CVSpec newBindingCVSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.COMPOSITE_VARIATION_POINT__BINDING_CV_SPEC, oldBindingCVSpec, bindingCVSpec));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.COMPOSITE_VARIATION_POINT__BINDING_CV_SPEC:
