 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToPlacementImpl#getToReplacement <em>To Replacement</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToPlacementImpl#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToPlacementImpl#getInsideBoundaryElement <em>Inside Boundary Element</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToPlacementImpl#getOutsideBoundaryElement <em>Outside Boundary Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToPlacementImpl extends PlacementBoundaryElementImpl implements ToPlacement {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.TO_PLACEMENT;
	}
		...
		if (toReplacement != null && toReplacement.eIsProxy()) {
			...
			if (toReplacement != oldToReplacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.TO_PLACEMENT__TO_REPLACEMENT, oldToReplacement, toReplacement));
			}
		}
	...
	public NotificationChain basicSetToReplacement(ToReplacement newToReplacement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.TO_PLACEMENT__TO_REPLACEMENT, oldToReplacement, newToReplacement);
	...
	public void setToReplacement(ToReplacement newToReplacement) {
		if (newToReplacement != toReplacement) {
			...
			if (toReplacement != null)
				msgs = ((InternalEObject)toReplacement).eInverseRemove(this, MainPackage.TO_REPLACEMENT__TO_PLACEMENT, ToReplacement.class, msgs);
			if (newToReplacement != null)
				msgs = ((InternalEObject)newToReplacement).eInverseAdd(this, MainPackage.TO_REPLACEMENT__TO_PLACEMENT, ToReplacement.class, msgs);
			msgs = basicSetToReplacement(newToReplacement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.TO_PLACEMENT__TO_REPLACEMENT, newToReplacement, newToReplacement));
	}
	...
	public void setPropertyName(String newPropertyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.TO_PLACEMENT__PROPERTY_NAME, oldPropertyName, propertyName));
	}
	...
	public EList<ObjectHandle> getInsideBoundaryElement() {
		if (insideBoundaryElement == null) {
			insideBoundaryElement = new EObjectResolvingEList<ObjectHandle>(ObjectHandle.class, this, MainPackage.TO_PLACEMENT__INSIDE_BOUNDARY_ELEMENT);
		}
	...
	public ObjectHandle getOutsideBoundaryElement() {
		if (outsideBoundaryElement != null && outsideBoundaryElement.eIsProxy()) {
			...
			if (outsideBoundaryElement != oldOutsideBoundaryElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.TO_PLACEMENT__OUTSIDE_BOUNDARY_ELEMENT, oldOutsideBoundaryElement, outsideBoundaryElement));
			}
		}
	...
	public void setOutsideBoundaryElement(ObjectHandle newOutsideBoundaryElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.TO_PLACEMENT__OUTSIDE_BOUNDARY_ELEMENT, oldOutsideBoundaryElement, outsideBoundaryElement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.TO_PLACEMENT__TO_REPLACEMENT:
				if (toReplacement != null)
					msgs = ((InternalEObject)toReplacement).eInverseRemove(this, MainPackage.TO_REPLACEMENT__TO_PLACEMENT, ToReplacement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MainPackage.TO_PLACEMENT__PROPERTY_NAME:
				return getPropertyName();
			case MainPackage.TO_PLACEMENT__INSIDE_BOUNDARY_ELEMENT:
				return getInsideBoundaryElement();
			case MainPackage.TO_PLACEMENT__OUTSIDE_BOUNDARY_ELEMENT:
