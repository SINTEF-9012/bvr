 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.VClassifierImpl#getInstanceMultiplicity <em>Instance Multiplicity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VClassifierImpl extends VSpecImpl implements VClassifier {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.VCLASSIFIER;
	}
	...
	public NotificationChain basicSetInstanceMultiplicity(MultiplicityInterval newInstanceMultiplicity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.VCLASSIFIER__INSTANCE_MULTIPLICITY, oldInstanceMultiplicity, newInstanceMultiplicity);
	...
	public void setInstanceMultiplicity(MultiplicityInterval newInstanceMultiplicity) {
		if (newInstanceMultiplicity != instanceMultiplicity) {
			...
			if (instanceMultiplicity != null)
				msgs = ((InternalEObject)instanceMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.VCLASSIFIER__INSTANCE_MULTIPLICITY, null, msgs);
			if (newInstanceMultiplicity != null)
				msgs = ((InternalEObject)newInstanceMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.VCLASSIFIER__INSTANCE_MULTIPLICITY, null, msgs);
			msgs = basicSetInstanceMultiplicity(newInstanceMultiplicity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.VCLASSIFIER__INSTANCE_MULTIPLICITY, newInstanceMultiplicity, newInstanceMultiplicity));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.VCLASSIFIER__INSTANCE_MULTIPLICITY:
