 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FragmentSubstitutionImpl#getBindingClassifier <em>Binding Classifier</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FragmentSubstitutionImpl#getBoundaryElementBinding <em>Boundary Element Binding</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FragmentSubstitutionImpl#getPlacement <em>Placement</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FragmentSubstitutionImpl#isMulti <em>Multi</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FragmentSubstitutionImpl#getReplacement <em>Replacement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FragmentSubstitutionImpl extends ChoiceVariationPointImpl implements FragmentSubstitution {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.FRAGMENT_SUBSTITUTION;
	}
		...
		if (bindingClassifier != null && bindingClassifier.eIsProxy()) {
			...
			if (bindingClassifier != oldBindingClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.FRAGMENT_SUBSTITUTION__BINDING_CLASSIFIER, oldBindingClassifier, bindingClassifier));
			}
		}
	...
	public void setBindingClassifier(VClassifier newBindingClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FRAGMENT_SUBSTITUTION__BINDING_CLASSIFIER, oldBindingClassifier, bindingClassifier));
	}
	...
	public EList<BoundaryElementBinding> getBoundaryElementBinding() {
		if (boundaryElementBinding == null) {
			boundaryElementBinding = new EObjectContainmentEList<BoundaryElementBinding>(BoundaryElementBinding.class, this, MainPackage.FRAGMENT_SUBSTITUTION__BOUNDARY_ELEMENT_BINDING);
		}
	...
	public PlacementFragment getPlacement() {
		if (placement != null && placement.eIsProxy()) {
			...
			if (placement != oldPlacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.FRAGMENT_SUBSTITUTION__PLACEMENT, oldPlacement, placement));
			}
		}
		return placement;
	}
	...
	public void setPlacement(PlacementFragment newPlacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FRAGMENT_SUBSTITUTION__PLACEMENT, oldPlacement, placement));
	}
	...
	public void setMulti(boolean newMulti) {
		...
		multi = newMulti;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FRAGMENT_SUBSTITUTION__MULTI, oldMulti, multi));
	}
	...
	public ReplacementFragmentType getReplacement() {
		if (replacement != null && replacement.eIsProxy()) {
			...
			if (replacement != oldReplacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.FRAGMENT_SUBSTITUTION__REPLACEMENT, oldReplacement, replacement));
			}
		}
		return replacement;
	}
	...
	public void setReplacement(ReplacementFragmentType newReplacement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FRAGMENT_SUBSTITUTION__REPLACEMENT, oldReplacement, replacement));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.FRAGMENT_SUBSTITUTION__BOUNDARY_ELEMENT_BINDING:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.FRAGMENT_SUBSTITUTION__BINDING_CLASSIFIER:
				if (resolve) return getBindingClassifier();
				return basicGetBindingClassifier();
			case MainPackage.FRAGMENT_SUBSTITUTION__BOUNDARY_ELEMENT_BINDING:
				return getBoundaryElementBinding();
			case MainPackage.FRAGMENT_SUBSTITUTION__PLACEMENT:
				if (resolve) return getPlacement();
				return basicGetPlacement();
			case MainPackage.FRAGMENT_SUBSTITUTION__MULTI:
				return isMulti();
			case MainPackage.FRAGMENT_SUBSTITUTION__REPLACEMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RepeatableVariationPoint.class) {
			switch (derivedFeatureID) {
				case MainPackage.FRAGMENT_SUBSTITUTION__BINDING_CLASSIFIER: return MainPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RepeatableVariationPoint.class) {
			switch (baseFeatureID) {
				case MainPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER: return MainPackage.FRAGMENT_SUBSTITUTION__BINDING_CLASSIFIER;
				default: return -1;
			}
		}
