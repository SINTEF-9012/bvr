 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FromPlacementImpl#getFromReplacement <em>From Replacement</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.FromPlacementImpl#getOutsideBoundaryElement <em>Outside Boundary Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromPlacementImpl extends PlacementBoundaryElementImpl implements FromPlacement {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.FROM_PLACEMENT;
	}
		...
		if (fromReplacement != null && fromReplacement.eIsProxy()) {
			...
			if (fromReplacement != oldFromReplacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.FROM_PLACEMENT__FROM_REPLACEMENT, oldFromReplacement, fromReplacement));
			}
		}
	...
	public NotificationChain basicSetFromReplacement(FromReplacement newFromReplacement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.FROM_PLACEMENT__FROM_REPLACEMENT, oldFromReplacement, newFromReplacement);
	...
	public void setFromReplacement(FromReplacement newFromReplacement) {
		if (newFromReplacement != fromReplacement) {
			...
			if (fromReplacement != null)
				msgs = ((InternalEObject)fromReplacement).eInverseRemove(this, MainPackage.FROM_REPLACEMENT__FROM_PLACEMENT, FromReplacement.class, msgs);
			if (newFromReplacement != null)
				msgs = ((InternalEObject)newFromReplacement).eInverseAdd(this, MainPackage.FROM_REPLACEMENT__FROM_PLACEMENT, FromReplacement.class, msgs);
			msgs = basicSetFromReplacement(newFromReplacement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.FROM_PLACEMENT__FROM_REPLACEMENT, newFromReplacement, newFromReplacement));
	}
	...
	public EList<ObjectHandle> getOutsideBoundaryElement() {
		if (outsideBoundaryElement == null) {
			outsideBoundaryElement = new EObjectResolvingEList<ObjectHandle>(ObjectHandle.class, this, MainPackage.FROM_PLACEMENT__OUTSIDE_BOUNDARY_ELEMENT);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.FROM_PLACEMENT__FROM_REPLACEMENT:
				if (fromReplacement != null)
					msgs = ((InternalEObject)fromReplacement).eInverseRemove(this, MainPackage.FROM_REPLACEMENT__FROM_PLACEMENT, FromReplacement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MainPackage.FROM_PLACEMENT__OUTSIDE_BOUNDARY_ELEMENT:
