 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToReplacementImpl#getInsideBoundaryElement <em>Inside Boundary Element</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ToReplacementImpl#getToPlacement <em>To Placement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToReplacementImpl extends ReplacementBoundaryElementImpl implements ToReplacement {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.TO_REPLACEMENT;
	}
	...
	public EList<ObjectHandle> getInsideBoundaryElement() {
		if (insideBoundaryElement == null) {
			insideBoundaryElement = new EObjectResolvingEList<ObjectHandle>(ObjectHandle.class, this, MainPackage.TO_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT);
		}
		...
		if (toPlacement != null && toPlacement.eIsProxy()) {
			...
			if (toPlacement != oldToPlacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.TO_REPLACEMENT__TO_PLACEMENT, oldToPlacement, toPlacement));
			}
		}
		return toPlacement;
	}
	...
	public NotificationChain basicSetToPlacement(ToPlacement newToPlacement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.TO_REPLACEMENT__TO_PLACEMENT, oldToPlacement, newToPlacement);
	...
	public void setToPlacement(ToPlacement newToPlacement) {
		if (newToPlacement != toPlacement) {
			...
			if (toPlacement != null)
				msgs = ((InternalEObject)toPlacement).eInverseRemove(this, MainPackage.TO_PLACEMENT__TO_REPLACEMENT, ToPlacement.class, msgs);
			if (newToPlacement != null)
				msgs = ((InternalEObject)newToPlacement).eInverseAdd(this, MainPackage.TO_PLACEMENT__TO_REPLACEMENT, ToPlacement.class, msgs);
			msgs = basicSetToPlacement(newToPlacement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.TO_REPLACEMENT__TO_PLACEMENT, newToPlacement, newToPlacement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.TO_REPLACEMENT__TO_PLACEMENT:
				if (toPlacement != null)
					msgs = ((InternalEObject)toPlacement).eInverseRemove(this, MainPackage.TO_PLACEMENT__TO_REPLACEMENT, ToPlacement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.TO_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT:
