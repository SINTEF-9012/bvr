 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.CVSpecImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CVSpecImpl extends VSpecImpl implements CVSpec {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.CV_SPEC;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.CV_SPEC__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(VInterface newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CV_SPEC__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.CV_SPEC__TYPE:
