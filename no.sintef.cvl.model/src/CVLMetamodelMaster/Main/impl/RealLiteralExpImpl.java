 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.RealLiteralExpImpl#getReal <em>Real</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealLiteralExpImpl extends NumericLiteralExpImpl implements RealLiteralExp {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.REAL_LITERAL_EXP;
	}
	...
	public void setReal(double newReal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.REAL_LITERAL_EXP__REAL, oldReal, real));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.REAL_LITERAL_EXP__REAL:
				return getReal();
		}
