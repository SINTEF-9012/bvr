 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.LinkExistenceImpl#getOptionalLink <em>Optional Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkExistenceImpl extends ChoiceVariationPointImpl implements LinkExistence {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.LINK_EXISTENCE;
	}
	...
	public NotificationChain basicSetOptionalLink(LinkHandle newOptionalLink, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.LINK_EXISTENCE__OPTIONAL_LINK, oldOptionalLink, newOptionalLink);
	...
	public void setOptionalLink(LinkHandle newOptionalLink) {
		if (newOptionalLink != optionalLink) {
			...
			if (optionalLink != null)
				msgs = ((InternalEObject)optionalLink).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.LINK_EXISTENCE__OPTIONAL_LINK, null, msgs);
			if (newOptionalLink != null)
				msgs = ((InternalEObject)newOptionalLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.LINK_EXISTENCE__OPTIONAL_LINK, null, msgs);
			msgs = basicSetOptionalLink(newOptionalLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.LINK_EXISTENCE__OPTIONAL_LINK, newOptionalLink, newOptionalLink));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.LINK_EXISTENCE__OPTIONAL_LINK:
