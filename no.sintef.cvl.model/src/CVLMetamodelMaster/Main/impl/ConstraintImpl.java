 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ConstraintImpl#getContext <em>Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintImpl extends VPackageableImpl implements Constraint {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.CONSTRAINT;
	}
		...
		if (context != null && context.eIsProxy()) {
			...
			if (context != oldContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.CONSTRAINT__CONTEXT, oldContext, context));
			}
		}
		return context;
	}
	...
	public void setContext(VSpec newContext) {
		...
		context = newContext;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.CONSTRAINT__CONTEXT, oldContext, context));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.CONSTRAINT__CONTEXT:
