 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.LinkEndSubstitutionImpl#getLink <em>Link</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.LinkEndSubstitutionImpl#getLinkEndIdentifier <em>Link End Identifier</em>}</li>
 *   <li>{@link CVLMetamodelMaster.Main.impl.LinkEndSubstitutionImpl#getReplacementObject <em>Replacement Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkEndSubstitutionImpl extends ChoiceVariationPointImpl implements LinkEndSubstitution {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.LINK_END_SUBSTITUTION;
	}
	...
	public NotificationChain basicSetLink(LinkHandle newLink, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.LINK_END_SUBSTITUTION__LINK, oldLink, newLink);
	...
	public void setLink(LinkHandle newLink) {
		if (newLink != link) {
			...
			if (link != null)
				msgs = ((InternalEObject)link).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.LINK_END_SUBSTITUTION__LINK, null, msgs);
			if (newLink != null)
				msgs = ((InternalEObject)newLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.LINK_END_SUBSTITUTION__LINK, null, msgs);
			msgs = basicSetLink(newLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.LINK_END_SUBSTITUTION__LINK, newLink, newLink));
	}
	...
	public void setLinkEndIdentifier(String newLinkEndIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.LINK_END_SUBSTITUTION__LINK_END_IDENTIFIER, oldLinkEndIdentifier, linkEndIdentifier));
	}
	...
	public NotificationChain basicSetReplacementObject(ObjectHandle newReplacementObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MainPackage.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT, oldReplacementObject, newReplacementObject);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setReplacementObject(ObjectHandle newReplacementObject) {
		if (newReplacementObject != replacementObject) {
			...
			if (replacementObject != null)
				msgs = ((InternalEObject)replacementObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MainPackage.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT, null, msgs);
			if (newReplacementObject != null)
				msgs = ((InternalEObject)newReplacementObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MainPackage.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT, null, msgs);
			msgs = basicSetReplacementObject(newReplacementObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT, newReplacementObject, newReplacementObject));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MainPackage.LINK_END_SUBSTITUTION__LINK:
				return basicSetLink(null, msgs);
			case MainPackage.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.LINK_END_SUBSTITUTION__LINK:
				return getLink();
			case MainPackage.LINK_END_SUBSTITUTION__LINK_END_IDENTIFIER:
