 ...
 * <ul>
 *   <li>{@link CVLMetamodelMaster.Main.impl.ParametricVariationPointImpl#getBindingVariable <em>Binding Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ParametricVariationPointImpl extends VariationPointImpl implements ParametricVariationPoint {
	...
	protected EClass eStaticClass() {
		return MainPackage.Literals.PARAMETRIC_VARIATION_POINT;
	}
		...
		if (bindingVariable != null && bindingVariable.eIsProxy()) {
			...
			if (bindingVariable != oldBindingVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MainPackage.PARAMETRIC_VARIATION_POINT__BINDING_VARIABLE, oldBindingVariable, bindingVariable));
			}
		}
	...
	public void setBindingVariable(Variable newBindingVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.PARAMETRIC_VARIATION_POINT__BINDING_VARIABLE, oldBindingVariable, bindingVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MainPackage.PARAMETRIC_VARIATION_POINT__BINDING_VARIABLE:
