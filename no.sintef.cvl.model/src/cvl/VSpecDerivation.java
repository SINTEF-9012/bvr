 ...
 * <ul>
 *   <li>{@link cvl.VSpecDerivation#getDerivedVSpec <em>Derived VSpec</em>}</li>
 * </ul>
 * </p>
 *
 * @see cvl.CvlPackage#getVSpecDerivation()
 * @model
 * @generated
 */
public interface VSpecDerivation extends VPackageable {
	 ...
	 * @see cvl.CvlPackage#getVSpecDerivation_DerivedVSpec()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link cvl.VSpecDerivation#getDerivedVSpec <em>Derived VSpec</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
