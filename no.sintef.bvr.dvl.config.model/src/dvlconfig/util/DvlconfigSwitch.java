 ...
 * @generated
 */
public class DvlconfigSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DvlconfigPackage.CONFIG: {
				Config config = (Config)theEObject;
				T result = caseConfig(config);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.OPERATOR: {
				Operator operator = (Operator)theEObject;
				T result = caseOperator(operator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.RESOURCE: {
				Resource resource = (Resource)theEObject;
				T result = caseResource(resource);
				if (result == null) result = caseLocatable(resource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.ORIGINAL: {
				Original original = (Original)theEObject;
				T result = caseOriginal(original);
				if (result == null) result = caseState(original);
				if (result == null) result = caseLocatable(original);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.GOAL: {
				Goal goal = (Goal)theEObject;
				T result = caseGoal(goal);
				if (result == null) result = caseState(goal);
				if (result == null) result = caseLocatable(goal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.LOCATABLE: {
				Locatable locatable = (Locatable)theEObject;
				T result = caseLocatable(locatable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = caseLocatable(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DvlconfigPackage.REALOP: {
				Realop realop = (Realop)theEObject;
				T result = caseRealop(realop);
				if (result == null) result = caseLocatable(realop);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
