...
import org.bangbangbang.cvl.system.def.edit.policies.CVLMetamodelTextSelectionEditPolicy;
...
import org.bangbangbang.cvl.system.def.providers.CVLMetamodelParserProvider;
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(org.bangbangbang.cvl.system.def.edit.parts.MultiplicityIntervalLowerUpperEditPart.VISUAL_ID));
		}
		return parser;
	}
