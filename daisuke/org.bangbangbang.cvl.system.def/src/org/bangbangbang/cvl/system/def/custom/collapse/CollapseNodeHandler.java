package org.bangbangbang.cvl.system.def.custom.collapse;

import java.util.List;

import org.bangbangbang.cvl.system.def.edit.parts.VSpecChildEditPart;
import org.bangbangbang.cvl.system.def.part.CVLSystemDefEditor;
...
public class CollapseNodeHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (!(editorPart instanceof CVLSystemDefEditor)) {
			return null;
		}
		CVLSystemDefEditor cvlEditorPart = (CVLSystemDefEditor) editorPart;
