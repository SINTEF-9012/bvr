 ...
 * @generated
 */
public class ChoiceChoiceGroupMultiplicityCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<CVLMetamodelNodeDescriptor> childDescriptors = CVLMetamodelDiagramUpdater
				.getChoiceChoiceGroupMultiplicityCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<CVLMetamodelNodeDescriptor> childDescriptors = CVLMetamodelDiagramUpdater
				.getChoiceChoiceGroupMultiplicityCompartment_7002SemanticChildren((View) getHost()
						.getModel());
