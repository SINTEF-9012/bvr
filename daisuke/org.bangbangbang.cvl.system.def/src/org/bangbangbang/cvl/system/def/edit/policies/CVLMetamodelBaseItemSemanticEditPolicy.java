...
import org.bangbangbang.cvl.system.def.expressions.CVLMetamodelOCLFactory;
...
public class CVLMetamodelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = CVLSystemDefEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			CVLSystemDefEditorPlugin.getInstance().setLinkConstraints(
