...
import org.bangbangbang.cvl.system.def.part.CVLMetamodelDiagramUpdater;
import org.bangbangbang.cvl.system.def.part.CVLMetamodelNodeDescriptor;
 ...
 * @generated
 */
public class VClassifierVClassifierInstanceMultiplicityIntervalCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return CvlPackage.eINSTANCE.getVClassifier_InstanceMultiplicity();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<CVLMetamodelNodeDescriptor> childDescriptors = CVLMetamodelDiagramUpdater
				.getVClassifierVClassifierInstanceMultiplicityIntervalCompartment_7004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MultiplicityInterval3EditPart.VISUAL_ID == CVLMetamodelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<CVLMetamodelNodeDescriptor> childDescriptors = CVLMetamodelDiagramUpdater
				.getVClassifierVClassifierInstanceMultiplicityIntervalCompartment_7004SemanticChildren((View) getHost()
						.getModel());
