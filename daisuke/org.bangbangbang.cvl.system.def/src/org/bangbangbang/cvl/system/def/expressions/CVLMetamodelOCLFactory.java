package org.bangbangbang.cvl.system.def.expressions;
...
public class CVLMetamodelOCLFactory {
	...
	private static CVLMetamodelOCLFactory getInstance() {
		CVLMetamodelOCLFactory instance = CVLSystemDefEditorPlugin
				.getInstance().getCVLMetamodelOCLFactory();
		if (instance == null) {
			CVLSystemDefEditorPlugin.getInstance().setCVLMetamodelOCLFactory(
