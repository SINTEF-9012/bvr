...
import org.bangbangbang.cvl.system.vspec.edit.policies.ChoiceCanonicalEditPolicy;
import org.bangbangbang.cvl.system.vspec.edit.policies.ChoiceItemSemanticEditPolicy;
...
public class ChoiceEditPart extends ShapeNodeEditPart {
	...
	public class ChoiceFigure extends RectangleFigure {
		...
		public void updateFace() {
			Choice node = (Choice) ((Node) ChoiceEditPart.this.getModel())
					.getElement();

			VSpecChildEditPart connection = null;
			for (int i = 0; i < ChoiceEditPart.this.getTargetConnections()
					.size(); i++) {
				if (ChoiceEditPart.this.getTargetConnections().get(i) instanceof VSpecChildEditPart) {
					connection = (VSpecChildEditPart) ChoiceEditPart.this
