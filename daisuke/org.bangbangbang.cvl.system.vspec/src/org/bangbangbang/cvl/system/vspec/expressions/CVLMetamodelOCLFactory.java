package org.bangbangbang.cvl.system.vspec.expressions;
...
public class CVLMetamodelOCLFactory {
	...
	private static CVLMetamodelOCLFactory getInstance() {
		CVLMetamodelOCLFactory instance = CVLSystemVSpecEditorPlugin
				.getInstance().getCVLMetamodelOCLFactory();
		if (instance == null) {
			CVLSystemVSpecEditorPlugin.getInstance().setCVLMetamodelOCLFactory(
