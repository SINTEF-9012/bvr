...
import org.bangbangbang.cvl.system.vspec.expressions.CVLMetamodelOCLFactory;
...
public class CVLMetamodelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = CVLSystemVSpecEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			CVLSystemVSpecEditorPlugin.getInstance().setLinkConstraints(
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public boolean canCreateVSpecChild_4001(VSpec source, VSpec target) {
			if (source != null) {
				if (source.getChild().contains(target)) {
					return false;
				}
				if (source == target) {
					return false;
			...
			return canExistVSpecChild_4001(source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateConstraintContext_4002(Constraint source,
				VSpec target) {
			if (source != null) {
			...
			return canExistConstraintContext_4002(source, target);
		}
				...
				if (source == null) {
					...
					Map<String, EClassifier> env = Collections
							.<String, EClassifier> singletonMap(
									"oppositeEnd", CvlPackage.eINSTANCE.getVSpec()); //$NON-NLS-1$
					Object sourceVal = CVLMetamodelOCLFactory.getExpression(0,
							CvlPackage.eINSTANCE.getVSpec(), env).evaluate(
							source,
		 ...
		 * @generated
		 */
		public boolean canExistConstraintContext_4002(Constraint source,
				VSpec target) {
			return true;
		}
	}
