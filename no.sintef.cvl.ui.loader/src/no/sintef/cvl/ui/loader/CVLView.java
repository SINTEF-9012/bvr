...
import no.sintef.cvl.ui.command.AddBCLConstraint;
import no.sintef.cvl.ui.command.AddChoice;
import no.sintef.cvl.ui.command.AddChoiceResolutuion;
import no.sintef.cvl.ui.command.AddConfigurableUnit;
import no.sintef.cvl.ui.command.AddGroupMultiplicity;
import no.sintef.cvl.ui.command.AddOpaqueConstraint;
import no.sintef.cvl.ui.command.AddVClassifier;
