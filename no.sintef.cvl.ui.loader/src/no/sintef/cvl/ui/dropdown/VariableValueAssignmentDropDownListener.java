...
import no.sintef.cvl.ui.command.ChangeVSpecResolvedEvent;
import no.sintef.cvl.ui.command.SetDecisionEvent;
import no.sintef.cvl.ui.command.event.AddChoiceResolvedEvent;
import no.sintef.cvl.ui.command.event.AddVInstanceEvent;
import no.sintef.cvl.ui.command.event.AddVariableValueAssignmentEvent;
import no.sintef.cvl.ui.command.event.RemoveVSpecResolutionEvent;
