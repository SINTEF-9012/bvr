...
import cvl.diagram.edit.policies.VariableCanonicalEditPolicy;
import cvl.diagram.edit.policies.VariableItemSemanticEditPolicy;
...
public class VariableEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof cvl.diagram.edit.parts.VariableEditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
