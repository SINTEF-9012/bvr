...
import cvl.diagram.edit.policies.ChoiceCanonicalEditPolicy;
import cvl.diagram.edit.policies.ChoiceItemSemanticEditPolicy;
...
public class ChoiceEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof cvl.diagram.edit.parts.ChoiceEditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
