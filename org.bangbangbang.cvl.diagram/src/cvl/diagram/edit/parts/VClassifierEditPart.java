...
import cvl.diagram.edit.policies.VClassifierCanonicalEditPolicy;
import cvl.diagram.edit.policies.VClassifierItemSemanticEditPolicy;
...
public class VClassifierEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof cvl.diagram.edit.parts.VClassifierEditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
		return types;
	}
