...
import cvl.diagram.edit.policies.Choice2CanonicalEditPolicy;
import cvl.diagram.edit.policies.Choice2ItemSemanticEditPolicy;
...
public class Choice2EditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof cvl.diagram.edit.parts.Choice2EditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
