...
import org.bangbangbang.cvl.diagram.edit.policies.CVLMetamodelTextSelectionEditPolicy;
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(org.bangbangbang.cvl.diagram.edit.parts.OpaqueConstraintConstraintEditPart.VISUAL_ID));
		}
		return parser;
	}
