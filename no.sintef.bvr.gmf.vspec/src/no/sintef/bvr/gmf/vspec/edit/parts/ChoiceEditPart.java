...
import no.sintef.bvr.gmf.vspec.edit.policies.ChoiceCanonicalEditPolicy;
import no.sintef.bvr.gmf.vspec.edit.policies.ChoiceItemSemanticEditPolicy;
...
public class ChoiceEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof no.sintef.bvr.gmf.vspec.edit.parts.ChoiceEditPart) {
			types.add(BVRMetamodelElementTypes.VSpecChild_4001);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == BVRMetamodelElementTypes.MultiplicityInterval_3002) {
				return getChildBySemanticHint(BVRMetamodelVisualIDRegistry
