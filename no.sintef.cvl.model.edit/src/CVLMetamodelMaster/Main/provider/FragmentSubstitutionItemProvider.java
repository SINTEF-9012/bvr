...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.FragmentSubstitution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FragmentSubstitutionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.FRAGMENT_SUBSTITUTION__PLACEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.FRAGMENT_SUBSTITUTION__MULTI,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.FRAGMENT_SUBSTITUTION__REPLACEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MainPackage.Literals.FRAGMENT_SUBSTITUTION__BOUNDARY_ELEMENT_BINDING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.FRAGMENT_SUBSTITUTION__BOUNDARY_ELEMENT_BINDING,
				 MainFactory.eINSTANCE.createToBinding()));

		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.FRAGMENT_SUBSTITUTION__BOUNDARY_ELEMENT_BINDING,
				 MainFactory.eINSTANCE.createFromBinding()));
	}
