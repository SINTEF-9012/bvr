...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.LinkEndSubstitution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkEndSubstitutionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.LINK_END_SUBSTITUTION__LINK_END_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MainPackage.Literals.LINK_END_SUBSTITUTION__LINK);
			childrenFeatures.add(MainPackage.Literals.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.LINK_END_SUBSTITUTION__LINK,
				 MainFactory.eINSTANCE.createLinkHandle()));

		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.LINK_END_SUBSTITUTION__REPLACEMENT_OBJECT,
