...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.FromPlacement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.FROM_PLACEMENT__FROM_REPLACEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.FROM_PLACEMENT__OUTSIDE_BOUNDARY_ELEMENT,
				 true,
				 false,
				 true,
				 null,
