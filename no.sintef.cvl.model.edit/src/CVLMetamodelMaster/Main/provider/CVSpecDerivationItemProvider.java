...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.CVSpecDerivation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CVSpecDerivationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.CV_SPEC_DERIVATION__DERIVING_CVSPEC,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.CV_SPEC_DERIVATION__DERIVED_CV_SPEC,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MainPackage.Literals.CV_SPEC_DERIVATION__MEMBER_DERIVATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.CV_SPEC_DERIVATION__MEMBER_DERIVATION,
