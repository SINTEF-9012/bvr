...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.SlotAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotAssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.SLOT_ASSIGNMENT__SLOT_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MainPackage.Literals.SLOT_ASSIGNMENT__VALUE);
			childrenFeatures.add(MainPackage.Literals.SLOT_ASSIGNMENT__SLOT_OWNER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.SLOT_ASSIGNMENT__VALUE,
				 MainFactory.eINSTANCE.createObjectSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.SLOT_ASSIGNMENT__VALUE,
				 MainFactory.eINSTANCE.createReplacementFragmentSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.SLOT_ASSIGNMENT__VALUE,
				 MainFactory.eINSTANCE.createPrimitiveValueSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.SLOT_ASSIGNMENT__SLOT_OWNER,
