...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.VSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VSpecItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.VSPEC__RESOLUTION_TIME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MainPackage.Literals.VSPEC__GROUP_MULTIPLICITY);
			childrenFeatures.add(MainPackage.Literals.VSPEC__OWNED_VSPEC_DERIVATION);
			childrenFeatures.add(MainPackage.Literals.VSPEC__CHILD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.VSPEC__GROUP_MULTIPLICITY,
				 MainFactory.eINSTANCE.createMultiplicityInterval()));

		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.VSPEC__OWNED_VSPEC_DERIVATION,
		...
		newChildDescriptors.add
			(createChildParameter
				(MainPackage.Literals.VSPEC__CHILD,
