...
/**
 * This is the item provider adapter for a {@link CVLMetamodelMaster.Main.ChoiceResolutuion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.CHOICE_RESOLUTUION__RESOLVED_CHOICE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MainPackage.Literals.CHOICE_RESOLUTUION__DECISION,
				 true,
				 false,
				 false,
