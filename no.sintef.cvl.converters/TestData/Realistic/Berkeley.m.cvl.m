...
NotChunked : featureNIO :: _NotChunked ;

Chunked : featureChunkedNIO :: _Chunked ;
...
featureEvictor or featureEvictorDaemon or featureLookAheadCache or featureStatisticsEnvCaching implies featureMemoryBudget ;
...
featureLatch implies dummyFeatureLocking and featureCheckLeaks and featureDeleteDb and featureEvictor and featureFileHandleCache and featureFSync and featureINCompressor and featureMemoryBudget and featureStatisticsLock and featureTreeVisitor and featureTruncateDb and featureVerifier ;
