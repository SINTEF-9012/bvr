...
public class AddChoiceResolution<EDITOR_PANEL, MODEL_PANEL> implements Command<EDITOR_PANEL, MODEL_PANEL> {
	...
	public Command<EDITOR_PANEL, MODEL_PANEL> init(BVRUIKernelInterface<EDITOR_PANEL, MODEL_PANEL> rootPanel, Object p, JComponent parent,
			Map<JComponent, NamedElement> vmMap, List<JComponent> nodes, List<Pair<JComponent, JComponent>> bindings, BVRNotifiableController view) {
	...
	public JComponent execute() {
		...
		String choicename = (resolvedVSpec != null) ? VSpecFacade.eINSTANCE.getBaseName(resolvedVSpec) : "NULL !!!";
