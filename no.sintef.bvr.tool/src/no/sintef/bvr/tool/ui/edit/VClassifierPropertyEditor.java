...
public class VClassifierPropertyEditor extends ElementPropertyEditor {
	...
	public VClassifierPropertyEditor(BVRUIKernel _kernel, Command _okcommand, VSpec elem, JComponent _node, BVRNotifiableController _controller) {
		...
		top.add(p2);
		SpringUtilities.makeCompactGrid(p2, 1, 2, // rows, cols
				6, 6, // initX, initY
				6, 6); // xPad, yPad
