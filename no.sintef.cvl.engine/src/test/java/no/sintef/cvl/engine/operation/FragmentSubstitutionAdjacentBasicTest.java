...
public class FragmentSubstitutionAdjacentBasicTest {
	...
	public void testAdjacentTest1() throws Exception {
		...
		Assert.assertTrue("the fragment should be adjacent", adjacent1.getAdjacentFragments().size() == 1);
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent1.getAdjacentFragments().get(0).equals(adjacent2));
		Assert.assertTrue("the fragment should be adjacent", adjacent2.getAdjacentFragments().size() == 2);
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent2.getAdjacentFragments().contains(adjacent1));
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent2.getAdjacentFragments().contains(adjacent3));
		Assert.assertTrue("the fragment should be adjacent", adjacent3.getAdjacentFragments().size() == 1);
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent3.getAdjacentFragments().get(0).equals(adjacent2));
	...
	public void testAdjacentTest2() throws Exception {
		...
		Assert.assertTrue("the fragment should be adjacent", adjacent11.getAdjacentFragments().size() == 1);
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent11.getAdjacentFragments().get(0).equals(adjacent12));
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent11.getAdjacentFragments().get(0).getFragmentHolder().equals(adjacent2.getFragmentHolder()));
		Assert.assertTrue("the fragment should be adjacent", adjacent12.getAdjacentFragments().size() == 2);
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent12.getAdjacentFragments().contains(adjacent11));
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent12.getAdjacentFragments().contains(adjacent13));
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", this.getFragmentSubstitutionHolders(adjacent12.getAdjacentFragments()).contains(adjacent1.getFragmentHolder()));
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", this.getFragmentSubstitutionHolders(adjacent12.getAdjacentFragments()).contains(adjacent13.getFragmentHolder()));
		Assert.assertTrue("the fragment should be adjacent", adjacent13.getAdjacentFragments().size() == 1);
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent13.getAdjacentFragments().get(0).equals(adjacent12));
		Assert.assertTrue("the fragment is adjacent to the wrong fragment", adjacent13.getAdjacentFragments().get(0).getFragmentHolder().equals(adjacent2.getFragmentHolder()));
