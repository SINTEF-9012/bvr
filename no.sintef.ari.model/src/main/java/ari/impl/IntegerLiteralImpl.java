 ...
 * <ul>
 *   <li>{@link ari.impl.IntegerLiteralImpl#getLiteralValue <em>Literal Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class IntegerLiteralImpl extends ExpressionNodeImpl implements IntegerLiteral {
	/**
	...
	protected EClass eStaticClass() {
		return ariPackage.Literals.INTEGER_LITERAL;
	}
	...
	public void setLiteralValue(String newLiteralValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ariPackage.INTEGER_LITERAL__LITERAL_VALUE, oldLiteralValue, literalValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ariPackage.INTEGER_LITERAL__LITERAL_VALUE:
