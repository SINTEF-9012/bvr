 ...
 * @generated
 */
public class ariSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ariPackage.EXPRESSION_NODE: {
				ExpressionNode expressionNode = (ExpressionNode)theEObject;
				T result = caseExpressionNode(expressionNode);
				if (result == null) result = caseNamedElement(expressionNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.VARIABLE_TERM: {
				VariableTerm variableTerm = (VariableTerm)theEObject;
				T result = caseVariableTerm(variableTerm);
				if (result == null) result = caseExpressionNode(variableTerm);
				if (result == null) result = caseNamedElement(variableTerm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.INTEGER_LITERAL: {
				IntegerLiteral integerLiteral = (IntegerLiteral)theEObject;
				T result = caseIntegerLiteral(integerLiteral);
				if (result == null) result = caseExpressionNode(integerLiteral);
				if (result == null) result = caseNamedElement(integerLiteral);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.BINARY_EXPRESSION: {
				BinaryExpression binaryExpression = (BinaryExpression)theEObject;
				T result = caseBinaryExpression(binaryExpression);
				if (result == null) result = caseExpressionNode(binaryExpression);
				if (result == null) result = caseNamedElement(binaryExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.PLUS: {
				Plus plus = (Plus)theEObject;
				T result = casePlus(plus);
				if (result == null) result = caseBinaryExpression(plus);
				if (result == null) result = caseExpressionNode(plus);
				if (result == null) result = caseNamedElement(plus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.MINUS: {
				Minus minus = (Minus)theEObject;
				T result = caseMinus(minus);
				if (result == null) result = caseBinaryExpression(minus);
				if (result == null) result = caseExpressionNode(minus);
				if (result == null) result = caseNamedElement(minus);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.MULT: {
				Mult mult = (Mult)theEObject;
				T result = caseMult(mult);
				if (result == null) result = caseBinaryExpression(mult);
				if (result == null) result = caseExpressionNode(mult);
				if (result == null) result = caseNamedElement(mult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ariPackage.DIV: {
				...
				if (result == null) result = caseExpressionNode(div);
			...
			case ariPackage.POW: {
				...
				if (result == null) result = caseBinaryExpression(pow);
				if (result == null) result = caseExpressionNode(pow);
				if (result == null) result = caseNamedElement(pow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
