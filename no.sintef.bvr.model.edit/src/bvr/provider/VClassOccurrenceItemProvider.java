...
/**
 * This is the item provider adapter for a {@link bvr.VClassOccurrence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VClassOccurrenceItemProvider
	 ...
	 * @generated
	 */
	public VClassOccurrenceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VClassOccurrence_vType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VClassOccurrence_vType_feature", "_UI_VClassOccurrence_type"),
				 BvrPackage.Literals.VCLASS_OCCURRENCE__VTYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BvrPackage.Literals.VCLASS_OCCURRENCE__INSTANCE_MULTIPLICITY);
		}
	...
	/**
	 * This returns VClassOccurrence.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VClassOccurrence"));
	}
	...
	public String getText(Object object) {
		String label = ((VClassOccurrence)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VClassOccurrence_type") :
			getString("_UI_VClassOccurrence_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VClassOccurrence.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BvrPackage.Literals.VCLASS_OCCURRENCE__INSTANCE_MULTIPLICITY,
				 BvrFactory.eINSTANCE.createMultiplicityInterval()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == BvrPackage.Literals.VCLASS_OCCURRENCE__INSTANCE_MULTIPLICITY;
