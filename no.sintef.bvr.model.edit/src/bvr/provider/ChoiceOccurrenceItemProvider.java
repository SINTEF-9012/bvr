...
/**
 * This is the item provider adapter for a {@link bvr.ChoiceOccurrence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceOccurrenceItemProvider
	extends VNodeItemProvider
	implements
	 ...
	 * @generated
	 */
	public ChoiceOccurrenceItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addVTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChoiceOccurrence_vType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChoiceOccurrence_vType_feature", "_UI_ChoiceOccurrence_type"),
				 BvrPackage.Literals.CHOICE_OCCURRENCE__VTYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ChoiceOccurrence.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChoiceOccurrence"));
	}
	...
	public String getText(Object object) {
		String label = ((ChoiceOccurrence)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ChoiceOccurrence_type") :
			getString("_UI_ChoiceOccurrence_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChoiceOccurrence.class)) {
