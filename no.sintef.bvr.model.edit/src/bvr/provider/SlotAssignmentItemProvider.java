...
/**
 * This is the item provider adapter for a {@link bvr.SlotAssignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SlotAssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BvrPackage.Literals.SLOT_ASSIGNMENT__SLOT_IDENTIFIER,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BvrPackage.Literals.SLOT_ASSIGNMENT__VALUE);
			childrenFeatures.add(BvrPackage.Literals.SLOT_ASSIGNMENT__SLOT_OWNER);
		}
