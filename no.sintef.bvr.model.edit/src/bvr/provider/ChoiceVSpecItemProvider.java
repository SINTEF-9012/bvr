...
/**
 * This is the item provider adapter for a {@link bvr.ChoiceVSpec} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceVSpecItemProvider
	 ...
	 * @generated
	 */
	public ChoiceVSpecItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ChoiceVSpec)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ChoiceVSpec_type") :
			getString("_UI_ChoiceVSpec_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChoiceVSpec.class)) {
