...
import cvl.impl.VSpecResolutionImpl;
 ...
 * <ul>
 * <li>{@link no.sintef.cvl.model.impl.VInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated NOT
...
public class VirtualVClassifierImpl extends VSpecResolutionImpl implements
	...
	protected EClass eStaticClass() {
		// This class is not in Cvl Model
		return null;
	}
			...
			if (parent != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CvlPackage.VINSTANCE__TYPE, oldType, parent));
			}
		}
		return parent;
	}
