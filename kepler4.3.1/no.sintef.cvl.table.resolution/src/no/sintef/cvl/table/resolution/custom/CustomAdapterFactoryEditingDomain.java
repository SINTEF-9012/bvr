...
public class CustomAdapterFactoryEditingDomain extends
	...
	public Command createCommand(Class<? extends Command> commandClass,
		...
		Command command = editingDomain.createCommand(commandClass, commandParameter);
	...
	public void setOptimizeCopy(boolean optimizeCopy) {
		((AdapterFactoryEditingDomain) editingDomain).setOptimizeCopy(optimizeCopy);
	}
	...
	public void setResourceToReadOnlyMap(
		...
		((AdapterFactoryEditingDomain) editingDomain).setResourceToReadOnlyMap(resourceToReadOnlyMap);
	}
