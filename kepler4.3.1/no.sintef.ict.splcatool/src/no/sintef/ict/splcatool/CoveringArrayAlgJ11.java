...
public class CoveringArrayAlgJ11 extends CoveringArray {
	...
	public CoveringArrayAlgJ11(int t, CNF cnf, Map<Integer, String> nrid, Map<String, Integer> idnr, int threads) {
		this.t = t;
		this.cnf = cnf;
		this.nrid = nrid;
		this.idnr = idnr;
...
*/		
	...
	*/
			...
			CalcUncovered3Thread cut = new CalcUncovered3Thread(uncovered, null, vars, coverOnlyOnes, coverZerosOnly, invalid2w, idnr, solutions, invalid3w);
