...
public class ChoiceResolutionDropDownListener extends MouseAdapter {
	...
	public ChoiceResolutionDropDownListener(ChoiceResolutionPanel cp, ChoiceResolutuion c, Map<JComponent, NamedElement> vmMap, VSpecView view){
		this.cp = cp;
		this.vmMap = vmMap;
		this.view = view;
		this.c = c;
...
class ChoiceResolutionDropdown extends JPopupMenu {
	...
	JMenuItem anItem;
    public ChoiceResolutionDropdown(ChoiceResolutionPanel cp, ChoiceResolutuion c, VSpecView view, Map<JComponent, NamedElement> vmMap){
    	// Add
