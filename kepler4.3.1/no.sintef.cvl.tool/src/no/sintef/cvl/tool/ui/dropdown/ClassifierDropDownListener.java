...
public class ClassifierDropDownListener extends MouseAdapter {
	...
	public ClassifierDropDownListener(VClassifierPanel cp, Map<JComponent, NamedElement> vmMap, List<JComponent> nodes, List<Pair<JComponent, JComponent>> bindings, VSpecView view){
		this.cp = cp;
		this.vmMap = vmMap;
		this.nodes = nodes;
...
class ClassifierDropdown extends JPopupMenu {
	...
	JMenuItem anItem;
    public ClassifierDropdown(VClassifierPanel cp, Map<JComponent, NamedElement> vmMap, List<JComponent> nodes, List<Pair<JComponent, JComponent>> bindings, VSpecView view){
    	// Add
