 ...
 * @author ffouquet
 */
public class RectanglePanel extends JPanel implements ChangeAwareComponent {
    ...
    public boolean contains(int x, int y) {
        ...
        Rectangle2D.Double rec = new Rectangle2D.Double(xx, yy, w, h);
    ...
    public void setBounds(int x, int y, int width, int height) {
        ...
        g2.setComposite(AlphaComposite.Clear);
        g2.fillRect(shadowSize, shadowSize, w, h);
        g2.dispose();
        this.notifyUIChanged();
    }
