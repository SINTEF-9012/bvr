 ...
 * <ul>
 *   <li>{@link bvr.impl.VariableImpl#getReplacementFragmentTypesubsetstype <em>Replacement Fragment Typesubsetstype</em>}</li>
...
public class VariableImpl extends VSpecImpl implements Variable {
		...
		if (replacementFragmentTypesubsetstype != null && replacementFragmentTypesubsetstype.eIsProxy()) {
			...
			if (replacementFragmentTypesubsetstype != oldReplacementFragmentTypesubsetstype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.VARIABLE__REPLACEMENT_FRAGMENT_TYPESUBSETSTYPE, oldReplacementFragmentTypesubsetstype, replacementFragmentTypesubsetstype));
			}
		}
	...
	public void setReplacementFragmentTypesubsetstype(ReplacementFragmentType newReplacementFragmentTypesubsetstype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.VARIABLE__REPLACEMENT_FRAGMENT_TYPESUBSETSTYPE, oldReplacementFragmentTypesubsetstype, replacementFragmentTypesubsetstype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.VARIABLE__REPLACEMENT_FRAGMENT_TYPESUBSETSTYPE:
