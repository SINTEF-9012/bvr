 ...
 * <ul>
 *   <li>{@link bvr.impl.VInstanceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VInstanceImpl extends VSpecResolutionImpl implements VInstance {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.VINSTANCE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.VINSTANCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(VClassifier newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.VINSTANCE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.VINSTANCE__TYPE:
