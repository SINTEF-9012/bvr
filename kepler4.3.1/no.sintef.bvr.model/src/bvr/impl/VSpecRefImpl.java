 ...
 * <ul>
 *   <li>{@link bvr.impl.VSpecRefImpl#getVSpec <em>VSpec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VSpecRefImpl extends BCLExpressionImpl implements VSpecRef {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.VSPEC_REF;
	}
		...
		if (vSpec != null && vSpec.eIsProxy()) {
			...
			if (vSpec != oldVSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.VSPEC_REF__VSPEC, oldVSpec, vSpec));
			}
		}
		return vSpec;
	}
	...
	public void setVSpec(VSpec newVSpec) {
		...
		vSpec = newVSpec;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.VSPEC_REF__VSPEC, oldVSpec, vSpec));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.VSPEC_REF__VSPEC:
