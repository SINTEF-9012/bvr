 ...
 * <ul>
 *   <li>{@link bvr.impl.LinkHandleImpl#getMOFRef <em>MOF Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LinkHandleImpl extends BaseModelHandleImpl implements LinkHandle {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.LINK_HANDLE;
	}
	...
	public void setMOFRef(String newMOFRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.LINK_HANDLE__MOF_REF, oldMOFRef, mofRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.LINK_HANDLE__MOF_REF:
				return getMOFRef();
		}
