...
import no.sintef.cvl.gmf.vspec.edit.policies.VariableCanonicalEditPolicy;
import no.sintef.cvl.gmf.vspec.edit.policies.VariableItemSemanticEditPolicy;
...
public class VariableEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new VariableCanonicalEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof no.sintef.cvl.gmf.vspec.edit.parts.VariableEditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
	 ...
	 * @generated
	 */
	public class VariableFigure extends Ellipse {
		...
		public VariableFigure() {
			...
			this.setBorder(new MarginBorder(getMapMode().DPtoLP(0),
					getMapMode().DPtoLP(9), getMapMode().DPtoLP(9),
					getMapMode().DPtoLP(0)));
			createContents();
		}
