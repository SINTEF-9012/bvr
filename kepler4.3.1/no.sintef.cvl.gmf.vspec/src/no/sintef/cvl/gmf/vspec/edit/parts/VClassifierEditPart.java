...
import no.sintef.cvl.gmf.vspec.edit.policies.VClassifierCanonicalEditPolicy;
import no.sintef.cvl.gmf.vspec.edit.policies.VClassifierItemSemanticEditPolicy;
...
import cvl.impl.VClassifierImpl;
...
public class VClassifierEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof no.sintef.cvl.gmf.vspec.edit.parts.VClassifierEditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
		return types;
	}
	...
	protected void createInstanceMultiplicity() {
		...
		String compartemntsSemanticHint = CVLMetamodelVisualIDRegistry
				.getType(no.sintef.cvl.gmf.vspec.edit.parts.VClassifierMultiplicityIntervalCompartment2EditPart.VISUAL_ID);
