 ...
 * @generated
 */
public class MultiplicityIntervalLowerUpper3EditPart extends
	 ...
	 * @generated
	 */
	public MultiplicityIntervalLowerUpper3EditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpper3EditPart.VISUAL_ID));
		}
		return parser;
	}
