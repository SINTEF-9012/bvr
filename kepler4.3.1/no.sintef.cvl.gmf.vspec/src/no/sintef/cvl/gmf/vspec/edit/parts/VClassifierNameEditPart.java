 ...
 * @generated
 */
public class VClassifierNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VClassifierNameEditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.VClassifierNameEditPart.VISUAL_ID));
		}
		return parser;
	}
