...
import no.sintef.cvl.gmf.vspec.edit.policies.CVLMetamodelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class OpaqueConstraintConstraintEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OpaqueConstraintConstraintEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CVLMetamodelParserProvider
					.getParser(
							CVLMetamodelElementTypes.OpaqueConstraint_2014,
							getParserElement(),
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.OpaqueConstraintConstraintEditPart.VISUAL_ID));
		}
		return parser;
	}
