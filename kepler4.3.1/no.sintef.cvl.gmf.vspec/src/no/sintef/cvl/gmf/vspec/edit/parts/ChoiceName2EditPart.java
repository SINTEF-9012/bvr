 ...
 * @generated
 */
public class ChoiceName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChoiceName2EditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.ChoiceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
