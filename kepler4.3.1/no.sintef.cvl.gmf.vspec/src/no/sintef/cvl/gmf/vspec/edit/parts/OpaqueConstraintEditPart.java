...
import no.sintef.cvl.gmf.vspec.edit.policies.OpaqueConstraintCanonicalEditPolicy;
import no.sintef.cvl.gmf.vspec.edit.policies.OpaqueConstraintItemSemanticEditPolicy;
...
public class OpaqueConstraintEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OpaqueConstraintConstraintEditPart) {
			((OpaqueConstraintConstraintEditPart) childEditPart)
