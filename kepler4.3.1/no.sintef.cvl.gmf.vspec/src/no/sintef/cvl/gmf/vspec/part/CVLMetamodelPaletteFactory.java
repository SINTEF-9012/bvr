...
public class CVLMetamodelPaletteFactory {
	...
	private ToolEntry createVSpecChild1CreationTool() {
		...
		entry.setSmallIcon(CVLMetamodelDiagramEditorPlugin
				.findImageDescriptor("/no.sintef.cvl.model.edit/icons/full/obj16/ChildNode.gif")); //$NON-NLS-1$
	...
	private ToolEntry createVSpecGroupMultiplicity2CreationTool() {
		...
		entry.setSmallIcon(CVLMetamodelDiagramEditorPlugin
				.findImageDescriptor("/no.sintef.cvl.model.edit/icons/full/obj16/MultiplicityInterval.gif")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createOpaqueConstraint3CreationTool() {
		...
		entry.setSmallIcon(CVLMetamodelDiagramEditorPlugin
				.findImageDescriptor("/no.sintef.cvl.model.edit/icons/full/obj16/OpaqueConstraint.gif")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createOpaqueConstraintLink4CreationTool() {
		...
		entry.setSmallIcon(CVLMetamodelDiagramEditorPlugin
				.findImageDescriptor("/no.sintef.cvl.model.edit/icons/full/obj16/ConstraintLine.gif")); //$NON-NLS-1$
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
