...
public class SetGroupToNoneEvent implements ActionListener {
	...
	public SetGroupToNoneEvent(JComponent p, Map<JComponent, NamedElement> vmMap, List<JComponent> nodes, List<Pair<JComponent, JComponent>> bindings, BVRNotifiableController view) {
		this.p = p;
		this.vmMap = vmMap;
		this.view = view;
	}
