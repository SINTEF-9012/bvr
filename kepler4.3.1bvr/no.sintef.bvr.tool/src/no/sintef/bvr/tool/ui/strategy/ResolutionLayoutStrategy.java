 ...
 */
	public ResolutionLayoutStrategy(List<List<JComponent>> resolutionNodes, List<List<Pair<JComponent, JComponent>>> bindings,
			ArrayList<JScrollPane> resolutionPanes) {
		this.resolutionPanes = resolutionPanes;
