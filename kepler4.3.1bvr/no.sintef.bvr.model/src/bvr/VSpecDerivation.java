 ...
 * <ul>
 *   <li>{@link bvr.VSpecDerivation#getDerivedVSpec <em>Derived VSpec</em>}</li>
 * </ul>
 * </p>
 *
 * @see bvr.BvrPackage#getVSpecDerivation()
 * @model
 * @generated
 */
public interface VSpecDerivation extends VPackageable {
	 ...
	 * @see bvr.BvrPackage#getVSpecDerivation_DerivedVSpec()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link bvr.VSpecDerivation#getDerivedVSpec <em>Derived VSpec</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
