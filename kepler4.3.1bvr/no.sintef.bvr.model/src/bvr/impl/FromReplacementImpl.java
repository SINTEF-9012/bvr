 ...
 * <ul>
 *   <li>{@link bvr.impl.FromReplacementImpl#getPropertyName <em>Property Name</em>}</li>
 *   <li>{@link bvr.impl.FromReplacementImpl#getInsideBoundaryElement <em>Inside Boundary Element</em>}</li>
 *   <li>{@link bvr.impl.FromReplacementImpl#getOutsideBoundaryElement <em>Outside Boundary Element</em>}</li>
 *   <li>{@link bvr.impl.FromReplacementImpl#getFromPlacement <em>From Placement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FromReplacementImpl extends ReplacementBoundaryElementImpl implements FromReplacement {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.FROM_REPLACEMENT;
	}
	...
	public void setPropertyName(String newPropertyName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.FROM_REPLACEMENT__PROPERTY_NAME, oldPropertyName, propertyName));
	}
	...
	public ObjectHandle getInsideBoundaryElement() {
		if (insideBoundaryElement != null && insideBoundaryElement.eIsProxy()) {
			...
			if (insideBoundaryElement != oldInsideBoundaryElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.FROM_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT, oldInsideBoundaryElement, insideBoundaryElement));
			}
		}
	...
	public void setInsideBoundaryElement(ObjectHandle newInsideBoundaryElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.FROM_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT, oldInsideBoundaryElement, insideBoundaryElement));
	}
	...
	public EList<ObjectHandle> getOutsideBoundaryElement() {
		if (outsideBoundaryElement == null) {
			outsideBoundaryElement = new EObjectResolvingEList<ObjectHandle>(ObjectHandle.class, this, BvrPackage.FROM_REPLACEMENT__OUTSIDE_BOUNDARY_ELEMENT);
		}
	...
	public FromPlacement getFromPlacement() {
		if (fromPlacement != null && fromPlacement.eIsProxy()) {
			...
			if (fromPlacement != oldFromPlacement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.FROM_REPLACEMENT__FROM_PLACEMENT, oldFromPlacement, fromPlacement));
			}
		}
	...
	public NotificationChain basicSetFromPlacement(FromPlacement newFromPlacement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.FROM_REPLACEMENT__FROM_PLACEMENT, oldFromPlacement, newFromPlacement);
	...
	public void setFromPlacement(FromPlacement newFromPlacement) {
		if (newFromPlacement != fromPlacement) {
			...
			if (fromPlacement != null)
				msgs = ((InternalEObject)fromPlacement).eInverseRemove(this, BvrPackage.FROM_PLACEMENT__FROM_REPLACEMENT, FromPlacement.class, msgs);
			if (newFromPlacement != null)
				msgs = ((InternalEObject)newFromPlacement).eInverseAdd(this, BvrPackage.FROM_PLACEMENT__FROM_REPLACEMENT, FromPlacement.class, msgs);
			msgs = basicSetFromPlacement(newFromPlacement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.FROM_REPLACEMENT__FROM_PLACEMENT, newFromPlacement, newFromPlacement));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.FROM_REPLACEMENT__FROM_PLACEMENT:
				if (fromPlacement != null)
					msgs = ((InternalEObject)fromPlacement).eInverseRemove(this, BvrPackage.FROM_PLACEMENT__FROM_REPLACEMENT, FromPlacement.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.FROM_REPLACEMENT__PROPERTY_NAME:
				return getPropertyName();
			case BvrPackage.FROM_REPLACEMENT__INSIDE_BOUNDARY_ELEMENT:
				if (resolve) return getInsideBoundaryElement();
				return basicGetInsideBoundaryElement();
			case BvrPackage.FROM_REPLACEMENT__OUTSIDE_BOUNDARY_ELEMENT:
