 ...
 * <ul>
 *   <li>{@link bvr.impl.ChoiceDerivationImpl#getDerivingConstraint <em>Deriving Constraint</em>}</li>
 *   <li>{@link bvr.impl.ChoiceDerivationImpl#getDerivedChoice <em>Derived Choice</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceDerivationImpl extends VSpecDerivationImpl implements ChoiceDerivation {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.CHOICE_DERIVATION;
	}
	...
	public NotificationChain basicSetDerivingConstraint(Constraint newDerivingConstraint, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.CHOICE_DERIVATION__DERIVING_CONSTRAINT, oldDerivingConstraint, newDerivingConstraint);
	...
	public void setDerivingConstraint(Constraint newDerivingConstraint) {
		if (newDerivingConstraint != derivingConstraint) {
			...
			if (derivingConstraint != null)
				msgs = ((InternalEObject)derivingConstraint).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.CHOICE_DERIVATION__DERIVING_CONSTRAINT, null, msgs);
			if (newDerivingConstraint != null)
				msgs = ((InternalEObject)newDerivingConstraint).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.CHOICE_DERIVATION__DERIVING_CONSTRAINT, null, msgs);
			msgs = basicSetDerivingConstraint(newDerivingConstraint, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CHOICE_DERIVATION__DERIVING_CONSTRAINT, newDerivingConstraint, newDerivingConstraint));
	}
	...
	public Choice getDerivedChoice() {
		if (derivedChoice != null && derivedChoice.eIsProxy()) {
			...
			if (derivedChoice != oldDerivedChoice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.CHOICE_DERIVATION__DERIVED_CHOICE, oldDerivedChoice, derivedChoice));
			}
		}
	...
	public void setDerivedChoice(Choice newDerivedChoice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CHOICE_DERIVATION__DERIVED_CHOICE, oldDerivedChoice, derivedChoice));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.CHOICE_DERIVATION__DERIVING_CONSTRAINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BvrPackage.CHOICE_DERIVATION__DERIVED_CHOICE:
