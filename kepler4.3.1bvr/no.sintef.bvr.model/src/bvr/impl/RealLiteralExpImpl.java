 ...
 * <ul>
 *   <li>{@link bvr.impl.RealLiteralExpImpl#getReal <em>Real</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealLiteralExpImpl extends NumericLiteralExpImpl implements RealLiteralExp {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.REAL_LITERAL_EXP;
	}
	...
	public void setReal(String newReal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.REAL_LITERAL_EXP__REAL, oldReal, real));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.REAL_LITERAL_EXP__REAL:
				return getReal();
		}
