 ...
 * <ul>
 *   <li>{@link bvr.impl.ChoiceResolutuionImpl#getResolvedChoice <em>Resolved Choice</em>}</li>
 *   <li>{@link bvr.impl.ChoiceResolutuionImpl#isDecision <em>Decision</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChoiceResolutuionImpl extends VSpecResolutionImpl implements ChoiceResolutuion {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.CHOICE_RESOLUTUION;
	}
		...
		if (resolvedChoice != null && resolvedChoice.eIsProxy()) {
			...
			if (resolvedChoice != oldResolvedChoice) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.CHOICE_RESOLUTUION__RESOLVED_CHOICE, oldResolvedChoice, resolvedChoice));
			}
		}
	...
	public void setResolvedChoice(Choice newResolvedChoice) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CHOICE_RESOLUTUION__RESOLVED_CHOICE, oldResolvedChoice, resolvedChoice));
	}
	...
	public void setDecision(boolean newDecision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CHOICE_RESOLUTUION__DECISION, oldDecision, decision));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.CHOICE_RESOLUTUION__RESOLVED_CHOICE:
