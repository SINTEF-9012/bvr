 ...
 * <ul>
 *   <li>{@link bvr.impl.VariableValueAssignmentImpl#getResolvedVariable <em>Resolved Variable</em>}</li>
 *   <li>{@link bvr.impl.VariableValueAssignmentImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableValueAssignmentImpl extends VSpecResolutionImpl implements VariableValueAssignment {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.VARIABLE_VALUE_ASSIGNMENT;
	}
		...
		if (resolvedVariable != null && resolvedVariable.eIsProxy()) {
			...
			if (resolvedVariable != oldResolvedVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.VARIABLE_VALUE_ASSIGNMENT__RESOLVED_VARIABLE, oldResolvedVariable, resolvedVariable));
			}
		}
	...
	public void setResolvedVariable(Variable newResolvedVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.VARIABLE_VALUE_ASSIGNMENT__RESOLVED_VARIABLE, oldResolvedVariable, resolvedVariable));
	}
	...
	public NotificationChain basicSetValue(ValueSpecification newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.VARIABLE_VALUE_ASSIGNMENT__VALUE, oldValue, newValue);
	...
	public void setValue(ValueSpecification newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.VARIABLE_VALUE_ASSIGNMENT__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.VARIABLE_VALUE_ASSIGNMENT__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.VARIABLE_VALUE_ASSIGNMENT__VALUE, newValue, newValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.VARIABLE_VALUE_ASSIGNMENT__RESOLVED_VARIABLE:
