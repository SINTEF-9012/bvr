 ...
 * <ul>
 *   <li>{@link bvr.impl.SlotValueExistenceImpl#getSlotIdentifier <em>Slot Identifier</em>}</li>
 *   <li>{@link bvr.impl.SlotValueExistenceImpl#getSlotOwner <em>Slot Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SlotValueExistenceImpl extends ChoiceVariationPointImpl implements SlotValueExistence {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.SLOT_VALUE_EXISTENCE;
	}
	...
	public void setSlotIdentifier(String newSlotIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_IDENTIFIER, oldSlotIdentifier, slotIdentifier));
	}
	...
	public NotificationChain basicSetSlotOwner(ObjectHandle newSlotOwner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_OWNER, oldSlotOwner, newSlotOwner);
	...
	public void setSlotOwner(ObjectHandle newSlotOwner) {
		if (newSlotOwner != slotOwner) {
			...
			if (slotOwner != null)
				msgs = ((InternalEObject)slotOwner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_OWNER, null, msgs);
			if (newSlotOwner != null)
				msgs = ((InternalEObject)newSlotOwner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_OWNER, null, msgs);
			msgs = basicSetSlotOwner(newSlotOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_OWNER, newSlotOwner, newSlotOwner));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_OWNER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.SLOT_VALUE_EXISTENCE__SLOT_IDENTIFIER:
