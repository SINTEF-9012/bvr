 ...
 * <ul>
 *   <li>{@link bvr.impl.ParametricObjectSubstitutionImpl#getPlacementObject <em>Placement Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParametricObjectSubstitutionImpl extends ParametricVariationPointImpl implements ParametricObjectSubstitution {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.PARAMETRIC_OBJECT_SUBSTITUTION;
	}
	...
	public NotificationChain basicSetPlacementObject(ObjectHandle newPlacementObject, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.PARAMETRIC_OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, oldPlacementObject, newPlacementObject);
	...
	public void setPlacementObject(ObjectHandle newPlacementObject) {
		if (newPlacementObject != placementObject) {
			...
			if (placementObject != null)
				msgs = ((InternalEObject)placementObject).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.PARAMETRIC_OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, null, msgs);
			if (newPlacementObject != null)
				msgs = ((InternalEObject)newPlacementObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.PARAMETRIC_OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, null, msgs);
			msgs = basicSetPlacementObject(newPlacementObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.PARAMETRIC_OBJECT_SUBSTITUTION__PLACEMENT_OBJECT, newPlacementObject, newPlacementObject));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.PARAMETRIC_OBJECT_SUBSTITUTION__PLACEMENT_OBJECT:
