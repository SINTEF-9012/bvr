 ...
 * <ul>
 *   <li>{@link bvr.impl.ObjectSpecificationImpl#getObject <em>Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ObjectSpecificationImpl extends ValueSpecificationImpl implements ObjectSpecification {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.OBJECT_SPECIFICATION;
	}
		...
		if (object != null && object.eIsProxy()) {
			...
			if (object != oldObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.OBJECT_SPECIFICATION__OBJECT, oldObject, object));
			}
		}
		return object;
	}
	...
	public void setObject(ObjectHandle newObject) {
		...
		object = newObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.OBJECT_SPECIFICATION__OBJECT, oldObject, object));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.OBJECT_SPECIFICATION__OBJECT:
