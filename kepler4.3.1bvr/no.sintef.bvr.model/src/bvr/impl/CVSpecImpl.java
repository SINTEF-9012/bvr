 ...
 * <ul>
 *   <li>{@link bvr.impl.CVSpecImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CVSpecImpl extends VSpecImpl implements CVSpec {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.CV_SPEC;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.CV_SPEC__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(VInterface newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CV_SPEC__TYPE, oldType, type));
	}
