 ...
 * <ul>
 *   <li>{@link bvr.impl.CVSpecDerivationImpl#getMemberDerivation <em>Member Derivation</em>}</li>
 *   <li>{@link bvr.impl.CVSpecDerivationImpl#getDerivingCVspec <em>Deriving CVspec</em>}</li>
 *   <li>{@link bvr.impl.CVSpecDerivationImpl#getDerivedCVSpec <em>Derived CV Spec</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CVSpecDerivationImpl extends VSpecDerivationImpl implements CVSpecDerivation {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.CV_SPEC_DERIVATION;
	}
	...
	public EList<VSpecDerivation> getMemberDerivation() {
		if (memberDerivation == null) {
			memberDerivation = new EObjectContainmentEList<VSpecDerivation>(VSpecDerivation.class, this, BvrPackage.CV_SPEC_DERIVATION__MEMBER_DERIVATION);
		}
		...
		if (derivingCVspec != null && derivingCVspec.eIsProxy()) {
			...
			if (derivingCVspec != oldDerivingCVspec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.CV_SPEC_DERIVATION__DERIVING_CVSPEC, oldDerivingCVspec, derivingCVspec));
			}
		}
	...
	public void setDerivingCVspec(CVSpec newDerivingCVspec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CV_SPEC_DERIVATION__DERIVING_CVSPEC, oldDerivingCVspec, derivingCVspec));
	}
	...
	public CVSpec getDerivedCVSpec() {
		if (derivedCVSpec != null && derivedCVSpec.eIsProxy()) {
			...
			if (derivedCVSpec != oldDerivedCVSpec) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BvrPackage.CV_SPEC_DERIVATION__DERIVED_CV_SPEC, oldDerivedCVSpec, derivedCVSpec));
			}
		}
	...
	public void setDerivedCVSpec(CVSpec newDerivedCVSpec) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.CV_SPEC_DERIVATION__DERIVED_CV_SPEC, oldDerivedCVSpec, derivedCVSpec));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.CV_SPEC_DERIVATION__MEMBER_DERIVATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case BvrPackage.CV_SPEC_DERIVATION__DERIVING_CVSPEC:
				if (resolve) return getDerivingCVspec();
				return basicGetDerivingCVspec();
			case BvrPackage.CV_SPEC_DERIVATION__DERIVED_CV_SPEC:
