 ...
 * <ul>
 *   <li>{@link bvr.impl.ParametricLinkEndSubstitutionImpl#getLinkEndIdentifier <em>Link End Identifier</em>}</li>
 *   <li>{@link bvr.impl.ParametricLinkEndSubstitutionImpl#getLink <em>Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParametricLinkEndSubstitutionImpl extends ParametricVariationPointImpl implements ParametricLinkEndSubstitution {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.PARAMETRIC_LINK_END_SUBSTITUTION;
	}
	...
	public void setLinkEndIdentifier(String newLinkEndIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK_END_IDENTIFIER, oldLinkEndIdentifier, linkEndIdentifier));
	}
	...
	public NotificationChain basicSetLink(LinkHandle newLink, NotificationChain msgs) {
		...
		link = newLink;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK, oldLink, newLink);
	...
	public void setLink(LinkHandle newLink) {
		if (newLink != link) {
			...
			if (link != null)
				msgs = ((InternalEObject)link).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK, null, msgs);
			if (newLink != null)
				msgs = ((InternalEObject)newLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK, null, msgs);
			msgs = basicSetLink(newLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK, newLink, newLink));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.PARAMETRIC_LINK_END_SUBSTITUTION__LINK_END_IDENTIFIER:
