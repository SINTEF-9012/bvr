 ...
 * <ul>
 *   <li>{@link bvr.impl.OpaqueConstraintImpl#getConstraint <em>Constraint</em>}</li>
 *   <li>{@link bvr.impl.OpaqueConstraintImpl#getConstraintLanguage <em>Constraint Language</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OpaqueConstraintImpl extends ConstraintImpl implements OpaqueConstraint {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.OPAQUE_CONSTRAINT;
	}
	...
	public void setConstraint(String newConstraint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.OPAQUE_CONSTRAINT__CONSTRAINT, oldConstraint, constraint));
	}
	...
	public void setConstraintLanguage(String newConstraintLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.OPAQUE_CONSTRAINT__CONSTRAINT_LANGUAGE, oldConstraintLanguage, constraintLanguage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.OPAQUE_CONSTRAINT__CONSTRAINT:
				return getConstraint();
			case BvrPackage.OPAQUE_CONSTRAINT__CONSTRAINT_LANGUAGE:
