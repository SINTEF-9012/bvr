 ...
 * <ul>
 *   <li>{@link bvr.VSpec#getGroupMultiplicity <em>Group Multiplicity</em>}</li>
 *   <li>{@link bvr.VSpec#getResolutionTime <em>Resolution Time</em>}</li>
 *   <li>{@link bvr.VSpec#getOwnedVSpecDerivation <em>Owned VSpec Derivation</em>}</li>
 *   <li>{@link bvr.VSpec#getChild <em>Child</em>}</li>
 *   <li>{@link bvr.VSpec#getComment <em>Comment</em>}</li>
 * </ul>
 * </p>
 *
...
public interface VSpec extends VPackageable {
	 ...
	 * @see bvr.BvrPackage#getVSpec_GroupMultiplicity()
	...
	/**
	 * Sets the value of the '{@link bvr.VSpec#getGroupMultiplicity <em>Group Multiplicity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * <p>The latest life-cycle stage at which this VSpec is expected to be resolved, e.g. "Design", "Link", "Build", "PostBuild", etc. It has no semantics within BVR.</p>
	 * <!-- end-model-doc -->
	 ...
	 * @see bvr.BvrPackage#getVSpec_OwnedVSpecDerivation()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see bvr.BvrPackage#getVSpec_Child()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
	 ...
	 * @see bvr.BvrPackage#getVSpec_Comment()
	 * @model
	 * @generated
	 */
	String getComment();
	...
	/**
	 * Sets the value of the '{@link bvr.VSpec#getComment <em>Comment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
