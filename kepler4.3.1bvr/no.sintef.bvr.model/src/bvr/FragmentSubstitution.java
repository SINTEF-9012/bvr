 ...
 * <ul>
 *   <li>{@link bvr.FragmentSubstitution#getBoundaryElementBinding <em>Boundary Element Binding</em>}</li>
 *   <li>{@link bvr.FragmentSubstitution#getPlacement <em>Placement</em>}</li>
 *   <li>{@link bvr.FragmentSubstitution#isMulti <em>Multi</em>}</li>
 *   <li>{@link bvr.FragmentSubstitution#getReplacement <em>Replacement</em>}</li>
 * </ul>
 * </p>
 *
 * @see bvr.BvrPackage#getFragmentSubstitution()
 * @model
 * @generated
 */
public interface FragmentSubstitution extends ChoiceVariationPoint, RepeatableVariationPoint {
	 ...
	 * The list contents are of type {@link bvr.BoundaryElementBinding}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * <p>
	 ...
	 * @see bvr.BvrPackage#getFragmentSubstitution_BoundaryElementBinding()
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * <p>Specifies the fragment to be replaced. The placement fragment will be removed once.</p>
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Placement</em>' reference.
	 * @see #setPlacement(PlacementFragment)
	 * @see bvr.BvrPackage#getFragmentSubstitution_Placement()
	...
	/**
	 * Sets the value of the '{@link bvr.FragmentSubstitution#getPlacement <em>Placement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * <p>Indicates multiple fragment substitution meaning that the substitution can be executed several times without removing the placement more than once.</p>
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Multi</em>' attribute.
	 * @see #setMulti(boolean)
	 * @see bvr.BvrPackage#getFragmentSubstitution_Multi()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	boolean isMulti();
	...
	/**
	 * Sets the value of the '{@link bvr.FragmentSubstitution#isMulti <em>Multi</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * <p>Specifies the replacement fragment that will replace the placement.</p>
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Replacement</em>' reference.
	 * @see #setReplacement(ReplacementFragmentType)
	 * @see bvr.BvrPackage#getFragmentSubstitution_Replacement()
	 * @model ordered="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link bvr.FragmentSubstitution#getReplacement <em>Replacement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
