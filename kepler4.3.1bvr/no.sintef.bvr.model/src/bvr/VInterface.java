 ...
 * <ul>
 *   <li>{@link bvr.VInterface#getMember <em>Member</em>}</li>
 *   <li>{@link bvr.VInterface#getOwnedConstraint <em>Owned Constraint</em>}</li>
 * </ul>
 * </p>
 *
 * @see bvr.BvrPackage#getVInterface()
 * @model
 * @generated
 */
public interface VInterface extends VPackageable {
	 ...
	 * @see bvr.BvrPackage#getVInterface_Member()
	 ...
	 * @see bvr.BvrPackage#getVInterface_OwnedConstraint()
	 * @model containment="true" ordered="false"
	 * @generated
	 */
