 ...
 * <ul>
 *   <li>{@link bvr.impl.BCLConstraintImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BCLConstraintImpl extends ConstraintImpl implements BCLConstraint {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.BCL_CONSTRAINT;
	}
	...
	public EList<BCLExpression> getExpression() {
		if (expression == null) {
			expression = new EObjectContainmentEList<BCLExpression>(BCLExpression.class, this, BvrPackage.BCL_CONSTRAINT__EXPRESSION);
		}
		return expression;
	}
