 ...
 * <ul>
 *   <li>{@link bvr.impl.BooleanLiteralExpImpl#isBool <em>Bool</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralExpImpl extends BCLExpressionImpl implements BooleanLiteralExp {
	...
	protected EClass eStaticClass() {
		return BvrPackage.Literals.BOOLEAN_LITERAL_EXP;
	}
	...
	public void setBool(boolean newBool) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BvrPackage.BOOLEAN_LITERAL_EXP__BOOL, oldBool, bool));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BvrPackage.BOOLEAN_LITERAL_EXP__BOOL:
				return isBool();
		}
