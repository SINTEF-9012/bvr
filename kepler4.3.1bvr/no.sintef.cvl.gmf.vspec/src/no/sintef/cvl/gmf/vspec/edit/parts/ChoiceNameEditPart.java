 ...
 * @generated
 */
public class ChoiceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChoiceNameEditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.ChoiceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
