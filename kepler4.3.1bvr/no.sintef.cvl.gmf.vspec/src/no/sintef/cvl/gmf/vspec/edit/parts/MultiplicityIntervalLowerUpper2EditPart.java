 ...
 * @generated
 */
public class MultiplicityIntervalLowerUpper2EditPart extends
	 ...
	 * @generated
	 */
	public MultiplicityIntervalLowerUpper2EditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpper2EditPart.VISUAL_ID));
		}
		return parser;
	}
