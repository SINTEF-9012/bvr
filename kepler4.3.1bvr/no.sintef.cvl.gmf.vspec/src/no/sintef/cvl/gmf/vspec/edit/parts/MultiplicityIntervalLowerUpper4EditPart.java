 ...
 * @generated
 */
public class MultiplicityIntervalLowerUpper4EditPart extends
	 ...
	 * @generated
	 */
	public MultiplicityIntervalLowerUpper4EditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpper4EditPart.VISUAL_ID));
		}
		return parser;
	}
