package no.sintef.cvl.gmf.vspec.navigator;

import no.sintef.cvl.gmf.vspec.edit.parts.Choice2EditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.ChoiceEditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.ChoiceName2EditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.ChoiceNameEditPart;
...
import no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpper2EditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpper3EditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpper4EditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpperEditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.OpaqueConstraintConstraintEditPart;
...
import no.sintef.cvl.gmf.vspec.edit.parts.VClassifierNameEditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.VSpecChildEditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.VariableEditPart;
import no.sintef.cvl.gmf.vspec.edit.parts.VariableNameEditPart;
...
import no.sintef.cvl.gmf.vspec.providers.CVLMetamodelParserProvider;
...
public class CVLMetamodelNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case ChoiceEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///cvl.ecore?Choice", CVLMetamodelElementTypes.Choice_2005); //$NON-NLS-1$
		case OpaqueConstraintEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///cvl.ecore?OpaqueConstraint", CVLMetamodelElementTypes.OpaqueConstraint_2014); //$NON-NLS-1$
		case Choice2EditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///cvl.ecore?Choice", CVLMetamodelElementTypes.Choice_2015); //$NON-NLS-1$
		case VariableEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///cvl.ecore?Variable", CVLMetamodelElementTypes.Variable_2016); //$NON-NLS-1$
		case VClassifierEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http:///cvl.ecore?VClassifier", CVLMetamodelElementTypes.VClassifier_2017); //$NON-NLS-1$
		...
		case ConstraintContextEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http:///cvl.ecore?Constraint?context", CVLMetamodelElementTypes.ConstraintContext_4003); //$NON-NLS-1$
		}
