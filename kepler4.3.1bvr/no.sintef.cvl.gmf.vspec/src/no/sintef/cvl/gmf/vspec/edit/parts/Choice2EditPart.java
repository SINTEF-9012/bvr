...
import no.sintef.cvl.gmf.vspec.edit.policies.Choice2CanonicalEditPolicy;
import no.sintef.cvl.gmf.vspec.edit.policies.Choice2ItemSemanticEditPolicy;
...
public class Choice2EditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof no.sintef.cvl.gmf.vspec.edit.parts.Choice2EditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
