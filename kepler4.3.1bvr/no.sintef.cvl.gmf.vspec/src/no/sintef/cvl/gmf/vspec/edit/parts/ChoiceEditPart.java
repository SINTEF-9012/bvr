...
import no.sintef.cvl.gmf.vspec.edit.policies.ChoiceCanonicalEditPolicy;
import no.sintef.cvl.gmf.vspec.edit.policies.ChoiceItemSemanticEditPolicy;
...
public class ChoiceEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof no.sintef.cvl.gmf.vspec.edit.parts.ChoiceEditPart) {
			types.add(CVLMetamodelElementTypes.VSpecChild_4001);
		}
