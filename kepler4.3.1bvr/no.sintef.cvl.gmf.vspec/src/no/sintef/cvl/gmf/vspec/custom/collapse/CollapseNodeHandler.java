package no.sintef.cvl.gmf.vspec.custom.collapse;

import java.util.List;

import no.sintef.cvl.gmf.vspec.edit.parts.VSpecChildEditPart;
import no.sintef.cvl.gmf.vspec.part.CVLMetamodelDiagramEditor;
...
public class CollapseNodeHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		CVLMetamodelDiagramEditor cvlEditorPart = (CVLMetamodelDiagramEditor) editorPart;
