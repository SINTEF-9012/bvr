...
import no.sintef.cvl.gmf.vspec.edit.policies.MultiplicityInterval4CanonicalEditPolicy;
import no.sintef.cvl.gmf.vspec.edit.policies.MultiplicityInterval4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MultiplicityInterval4EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MultiplicityInterval4EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MultiplicityInterval4ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new MultiplicityInterval4CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MultiplicityIntervalLowerUpper4EditPart) {
			((MultiplicityIntervalLowerUpper4EditPart) childEditPart)
