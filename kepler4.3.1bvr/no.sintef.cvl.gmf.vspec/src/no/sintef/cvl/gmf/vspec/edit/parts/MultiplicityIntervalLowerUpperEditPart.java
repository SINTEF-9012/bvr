 ...
 * @generated
 */
public class MultiplicityIntervalLowerUpperEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MultiplicityIntervalLowerUpperEditPart(View view) {
		super(view);
	}
			...
			parser = CVLMetamodelParserProvider
					.getParser(
							...
							CVLMetamodelVisualIDRegistry
									.getType(no.sintef.cvl.gmf.vspec.edit.parts.MultiplicityIntervalLowerUpperEditPart.VISUAL_ID));
		}
		return parser;
	}
