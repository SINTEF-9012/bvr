 ...
 * @generated
 */
public class VClassifierMultiplicityIntervalCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<CVLMetamodelNodeDescriptor> childDescriptors = CVLMetamodelDiagramUpdater
				.getVClassifierVClassifierInstanceMultiplicityIntervalCompartment_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<CVLMetamodelNodeDescriptor> childDescriptors = CVLMetamodelDiagramUpdater
				.getVClassifierVClassifierInstanceMultiplicityIntervalCompartment_7006SemanticChildren((View) getHost()
						.getModel());
