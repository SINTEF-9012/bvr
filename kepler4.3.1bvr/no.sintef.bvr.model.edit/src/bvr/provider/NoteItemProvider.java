...
/**
 * This is the item provider adapter for a {@link bvr.Note} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Note_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Note_kind_feature", "_UI_Note_type"),
				 BvrPackage.Literals.NOTE__KIND,
				 true,
				 false,
				 false,
	...
	protected void addExprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Note_expr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Note_expr_feature", "_UI_Note_type"),
				 BvrPackage.Literals.NOTE__EXPR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
